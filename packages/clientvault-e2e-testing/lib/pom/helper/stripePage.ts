...
export class StripePage {
  ...
  private readonly returnToClientVaultLink: Locator;
  ...
  constructor(public readonly page: Page) {
    ...
    this.returnToClientVaultLink = page.getByTestId('return-to-business-link');
  }
  ...
  async returnToClientVault() {
    await this.returnToClientVaultLink.click();
  }
}
