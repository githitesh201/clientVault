...
const clientvaultUiTest: Story['play'] = async ({ canvasElement }) => {
  const canvas = within(canvasElement);

  await canvas.findByTestId('clientvault-ui-component', {}, { timeout: 30000 });
...
export const ClientVaultUiReact: Story = createComponentStory('clientvault-ui-example', {
  play: clientvaultUiTest,
});
export const ClientVaultUiPreact: Story = createComponentStory(
  'clientvault-ui-example',
  { runtime: 'preact', play: clientvaultUiTest },
);
