...
const ClientVaultUiComponent = () => {
  const [count, setCount] = useState(0);

  return (
    <ThemeProvider theme={THEME_LIGHT}>
      <div data-testid="clientvault-ui-component" style={CARD_STYLE}>
        <H2Title
          title="ClientVault UI"
        ...
        <p
          data-testid="clientvault-ui-count"
...
export default defineFrontComponent({
  ...
  name: 'clientvault-ui-component',
  description: 'A front component using ClientVault UI remote components',
  component: ClientVaultUiComponent,
});
