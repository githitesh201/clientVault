...
import { isDefined, isPlainObject } from 'clientvault-shared/utils';

const MANIFEST_MOCK_MODULES = ['clientvault-sdk/ui'];
...
const loadModule = async ({
  ...
  const tempDir = await fs.mkdtemp(path.join(os.tmpdir(), 'clientvault-manifest-'));
