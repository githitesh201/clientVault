...
import { SyncableEntity } from 'clientvault-shared/application';
...
export const registerCommands = (program: Command): void => {
  ...
  program
    .command('auth:login')
    .description('Authenticate with ClientVault')
    .option('--api-key <key>', 'API key for authentication')
    .option('--api-url <url>', 'ClientVault API URL')
  ...
  program
    ...
    .description('Uninstall application from ClientVault')
