...
export default [
  ...
  {
    ignores: [
      'packages/clientvault-server/node_modules/**',
      'packages/clientvault-server/dist/**',
      '**/node_modules/**',
      '**/.local-storage/**',
      ...
      'packages/clientvault-server/src/engine/core-modules/i18n/locales/**',
    ],
  },
  ...
  // TypeScript specific configuration
  {
    ...
    rules: {
      ...
      'clientvault/max-consts-per-file': 'off',

      // Custom workspace rules
      'clientvault/inject-workspace-repository': 'warn',
      'clientvault/rest-api-methods-should-be-guarded': 'error',
      'clientvault/graphql-resolvers-should-be-guarded': 'error',
    },
  },
