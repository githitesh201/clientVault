...
import { FieldMetadataType, RelationType } from 'clientvault-shared/types';
import { computeMorphRelationFieldName } from 'clientvault-shared/utils';
import { v4 } from 'uuid';
      ...
      data: [
        {
          ...
          linksField: {
            ...
            primaryLinkLabel: 'clientvault - #1 Open source CRM',
            secondaryLinks: [
              {
                url: 'clientvault.com',
                label: 'clientvault - #1 Open source CRM',
              },
            ],
          },
          currencyField: {
