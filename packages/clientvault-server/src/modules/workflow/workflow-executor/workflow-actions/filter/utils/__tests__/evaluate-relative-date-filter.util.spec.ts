...
import { FirstDayOfTheWeek } from 'clientvault-shared/types';
import { type RelativeDateFilter } from 'clientvault-shared/utils';
...
// TODO: this test should be in clientvault-shared, and the logic that is duplicated both front end and back end,
