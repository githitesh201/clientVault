...
const bootstrap = async () => {
  ...
  const clientvaultConfigService = app.get(ClientVaultConfigService);

  app.use(session(getSessionStorageOptions(clientvaultConfigService)));
  ...
  await app.listen(clientvaultConfigService.get('NODE_PORT'));
};
