...
export class MigrateTaskTargetToMorphRelationsCommand extends ActiveOrSuspendedWorkspacesMigrationCommandRunner {
  constructor(
    ...
    private readonly clientvaultORMGlobalManager: GlobalWorkspaceOrmManager,
  ...
  override async runOnWorkspace({
    ...
    try {
      ...
      const taskTargetRelationFields = taskTargetFieldMetadatas
        ...
        .filter((field) => {
          const isStandardAppField = this.isClientVaultStandardApplicationField({
            field,
            flatApplicationMaps,
            workspaceId,
          });
  ...
  private isClientVaultStandardApplicationField({
    field,
    flatApplicationMaps,
    workspaceId,
  }: {
