...
import { fromArrayToUniqueKeyRecord, isDefined } from 'clientvault-shared/utils';
...
import {
  TAB_PROPS,
  WIDGET_PROPS,
} from 'src/engine/workspace-manager/clientvault-standard-application/constants/standard-page-layout-tabs.template';
