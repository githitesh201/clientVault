...
import { v4 } from 'uuid';
import { SEED_LOGIC_FUNCTION_INPUT_SCHEMA } from 'clientvault-shared/logic-function';
  ...
  private async getLogicFunctionContext({
    ...
    const [{ flatLogicFunctionMaps }, { workspaceCustomFlatApplication }] =
      await Promise.all([
        ...
        this.applicationService.findWorkspaceClientVaultStandardAndCustomApplicationOrThrow(
          { workspaceId },
        ),
      ]);
