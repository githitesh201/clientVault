import { isDefined, removePropertiesFromRecord } from 'clientvault-shared/utils';
...
export const fromObjectMetadataEntityToFlatObjectMetadata = ({
  ...
  if (isDefined(objectMetadataEntity.labelIdentifierFieldMetadataId)) {
    ...
    // TODO uncomment once https://github.com/clientvaulthq/core-team-issues/issues/2172 has been resolved
