import { trimAndRemoveDuplicatedWhitespacesFromObjectStringProperties } from 'clientvault-shared/utils';
import { v4 } from 'uuid';
import { ViewFilterGroupLogicalOperator } from 'clientvault-shared/types';
