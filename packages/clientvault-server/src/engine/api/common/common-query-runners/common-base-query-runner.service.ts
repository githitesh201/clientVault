...
> {
  ...
  @Inject()
  protected readonly clientvaultConfigService: ClientVaultConfigService;
  @Inject()
  ...
  private async throttleQueryExecution(authContext: WorkspaceAuthContext) {
    try {
      ...
      const shortConfig = {
        ...
        maxTokens: this.clientvaultConfigService.get(
          'API_RATE_LIMITING_SHORT_LIMIT',
        ),
        timeWindow: this.clientvaultConfigService.get(
      ...
      const longConfig = {
        ...
        maxTokens: this.clientvaultConfigService.get('API_RATE_LIMITING_LONG_LIMIT'),
        timeWindow: this.clientvaultConfigService.get(
  ...
  private validateQueryComplexity(
    ...
    const maximumComplexity = this.clientvaultConfigService.get(
