import { FieldMetadataType, type ObjectRecord } from 'clientvault-shared/types';
...
describe('RichTextV2FieldQueryResultGetterHandler', () => {
  ...
  beforeEach(() => {
    process.env.SERVER_URL = 'https://my-domain.clientvault.com';
  ...
  describe('should sign internal image URLs', () => {
    it('when image block has an internal attachment URL (legacy path)', async () => {
      ...
      const imageBlock = {
        ...
        props: {
          name: 'photo.jpg',
          url: 'https://my-domain.clientvault.com/files/attachment/some-token/photo.jpg',
          caption: '',
        },
        children: [],
      };
          ...
          blocknote: JSON.stringify([
            {
              ...
              props: {
                ...imageBlock.props,
                url: 'https://my-domain.clientvault.com/files/signed-path',
              },
            },
          ]),
        },
