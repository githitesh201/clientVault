...
export const metadataModuleFactory = async (
  ...
  const config: YogaDriverConfig = {
    ...
    plugins: [
      ...
      useDisableIntrospectionAndSuggestionsForUnauthenticatedUsers(
        clientvaultConfigService.get('NODE_ENV') === NodeEnvironment.PRODUCTION,
      ),
      useValidateGraphqlQueryComplexity({
        maximumAllowedFields: clientvaultConfigService.get('GRAPHQL_MAX_FIELDS'),
  ...
  if (clientvaultConfigService.get('NODE_ENV') === NodeEnvironment.DEVELOPMENT) {
