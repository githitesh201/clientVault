...
import { ClientVaultORMException } from 'src/engine/clientvault-orm/exceptions/clientvault-orm.exception';
import { clientvaultORMGraphqlApiExceptionHandler } from 'src/engine/clientvault-orm/utils/clientvault-orm-graphql-api-exception-handler.util';
...
export const workspaceQueryRunnerGraphqlApiExceptionHandler = (
  ...
  switch (true) {
    ...
    case error instanceof ClientVaultORMException:
      return clientvaultORMGraphqlApiExceptionHandler(error);
