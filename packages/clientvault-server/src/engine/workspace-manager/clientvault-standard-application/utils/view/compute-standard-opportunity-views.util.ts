import { AggregateOperations, ViewType } from 'clientvault-shared/types';
...
} from 'src/engine/workspace-manager/clientvault-standard-application/utils/view/create-standard-view-flat-metadata.util';
