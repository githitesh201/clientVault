...
import { computeStandardCompanyViewFieldGroups } from 'src/engine/workspace-manager/clientvault-standard-application/utils/view-field-group/compute-standard-company-view-field-groups.util';
import { computeStandardNoteViewFieldGroups } from 'src/engine/workspace-manager/clientvault-standard-application/utils/view-field-group/compute-standard-note-view-field-groups.util';
import { computeStandardOpportunityViewFieldGroups } from 'src/engine/workspace-manager/clientvault-standard-application/utils/view-field-group/compute-standard-opportunity-view-field-groups.util';
import { computeStandardPersonViewFieldGroups } from 'src/engine/workspace-manager/clientvault-standard-application/utils/view-field-group/compute-standard-person-view-field-groups.util';
import { computeStandardTaskViewFieldGroups } from 'src/engine/workspace-manager/clientvault-standard-application/utils/view-field-group/compute-standard-task-view-field-groups.util';
import { computeStandardWorkflowRunViewFieldGroups } from 'src/engine/workspace-manager/clientvault-standard-application/utils/view-field-group/compute-standard-workflow-run-view-field-groups.util';
import { computeStandardWorkflowVersionViewFieldGroups } from 'src/engine/workspace-manager/clientvault-standard-application/utils/view-field-group/compute-standard-workflow-version-view-field-groups.util';
import { type CreateStandardViewFieldGroupArgs } from 'src/engine/workspace-manager/clientvault-standard-application/utils/view-field-group/create-standard-view-field-group-flat-metadata.util';
