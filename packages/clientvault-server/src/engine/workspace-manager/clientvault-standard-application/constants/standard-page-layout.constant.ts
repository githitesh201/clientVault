...
import { type StandardRecordPageLayouts } from 'src/engine/workspace-manager/clientvault-standard-application/utils/page-layout-config/standard-page-layout-config.type';
