...
export const AGENT_DATA_SEED_IDS = {
  ...
  CLIENTVAULT_DEFAULT_AGENT: '20202020-0000-4000-8000-000000000002',
};

export const AGENT_CHAT_THREAD_DATA_SEED_IDS = {
  APPLE_DEFAULT_THREAD: '20202020-0000-4000-8000-000000000011',
  CLIENTVAULT_DEFAULT_THREAD: '20202020-0000-4000-8000-000000000012',
};
...
export const AGENT_CHAT_MESSAGE_DATA_SEED_IDS = {
  ...
  CLIENTVAULT_MESSAGE_1: '20202020-0000-4000-8000-000000000031',
  CLIENTVAULT_MESSAGE_2: '20202020-0000-4000-8000-000000000032',
  CLIENTVAULT_MESSAGE_3: '20202020-0000-4000-8000-000000000033',
  CLIENTVAULT_MESSAGE_4: '20202020-0000-4000-8000-000000000034',
};
...
export const AGENT_CHAT_MESSAGE_PART_DATA_SEED_IDS = {
  ...
  CLIENTVAULT_MESSAGE_1_PART_1: '20202020-0000-4000-8000-000000000051',
  CLIENTVAULT_MESSAGE_2_PART_1: '20202020-0000-4000-8000-000000000052',
  CLIENTVAULT_MESSAGE_3_PART_1: '20202020-0000-4000-8000-000000000053',
  CLIENTVAULT_MESSAGE_4_PART_1: '20202020-0000-4000-8000-000000000054',
};
...
const seedChatThreads = async ({
  ...
  } else if (workspaceId === SEED_CLIENTVAULT_WORKSPACE_ID) {
    threadId = AGENT_CHAT_THREAD_DATA_SEED_IDS.CLIENTVAULT_DEFAULT_THREAD;
...
const seedChatMessages = async ({
  ...
  if (workspaceId === SEED_APPLE_WORKSPACE_ID) {
    ...
    messageIds = [
      AGENT_CHAT_MESSAGE_DATA_SEED_IDS.CLIENTVAULT_MESSAGE_1,
      AGENT_CHAT_MESSAGE_DATA_SEED_IDS.CLIENTVAULT_MESSAGE_2,
      AGENT_CHAT_MESSAGE_DATA_SEED_IDS.CLIENTVAULT_MESSAGE_3,
      AGENT_CHAT_MESSAGE_DATA_SEED_IDS.CLIENTVAULT_MESSAGE_4,
    ];
    partIds = [
      AGENT_CHAT_MESSAGE_PART_DATA_SEED_IDS.CLIENTVAULT_MESSAGE_1_PART_1,
      AGENT_CHAT_MESSAGE_PART_DATA_SEED_IDS.CLIENTVAULT_MESSAGE_2_PART_1,
      AGENT_CHAT_MESSAGE_PART_DATA_SEED_IDS.CLIENTVAULT_MESSAGE_3_PART_1,
      AGENT_CHAT_MESSAGE_PART_DATA_SEED_IDS.CLIENTVAULT_MESSAGE_4_PART_1,
    ];
    turnIds = [
    ...
    messageParts = [
      ...
      },
      {
        ...
        type: 'text',
        textContent:
          'Hello! I can help you analyze startup trends and portfolio performance. From your ClientVault workspace data, I can see strong performance in AI/ML startups, particularly in the B2B SaaS space. Several companies are showing 40%+ month-over-month growth. Would you like me to provide specific company performance metrics or focus on broader industry trends?',
        createdAt: new Date(baseTime.getTime() + 3 * 60 * 1000),
      },
      {
        id: partIds[2],
