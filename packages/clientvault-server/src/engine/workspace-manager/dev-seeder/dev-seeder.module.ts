...
import { ClientVaultStandardApplicationModule } from 'src/engine/workspace-manager/clientvault-standard-application/clientvault-standard-application.module';
...
@Module({
  imports: [
    ...
    ClientVaultStandardApplicationModule,
  ],
