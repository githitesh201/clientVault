...
@Module({
  imports: [
    EnvironmentModule,
    ClientVaultConfigModule.forRoot(),
    HealthModule,
    AuditModule,
    AuthModule,
    BillingModule,
    ...
    MessageQueueModule.registerAsync({
      ...
      inject: [ClientVaultConfigService, RedisClientService, MetricsService],
    }),
    ExceptionHandlerModule.forRootAsync({
      useFactory: exceptionHandlerModuleFactory,
      inject: [ClientVaultConfigService, HttpAdapterHost],
    }),
    EmailModule.forRoot(),
    ...
    LogicFunctionModule.forRootAsync({
      ...
      inject: [ClientVaultConfigService, LogicFunctionResourceService],
    }),
