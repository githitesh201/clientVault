...
export class GoogleAPIsOauthExchangeCodeForTokenGuard extends AuthGuard(
  ...
  async canActivate(context: ExecutionContext) {
    try {
      ...
      if (
        !this.clientvaultConfigService.get('MESSAGING_PROVIDER_GMAIL_ENABLED') &&
        !this.clientvaultConfigService.get('CALENDAR_PROVIDER_GOOGLE_ENABLED')
      ) {
      ...
      new GoogleAPIsOauthExchangeCodeForTokenStrategy(this.clientvaultConfigService);
