...
describe('TwoFactorAuthenticationResolver', () => {
  ...
  describe('initiateOTPProvisioning', () => {
    ...
    const origin = 'https://app.clientvault.com';
    ...
    beforeEach(() => {
      ...
      twoFactorAuthenticationService.initiateStrategyConfiguration.mockResolvedValue(
        'otpauth://totp/ClientVault:test@example.com?secret=SECRETKEY&issuer=ClientVault',
      );
    });
    ...
    it('should successfully initiate OTP provisioning', async () => {
      ...
      expect(result).toEqual({
        uri: 'otpauth://totp/ClientVault:test@example.com?secret=SECRETKEY&issuer=ClientVault',
      });
