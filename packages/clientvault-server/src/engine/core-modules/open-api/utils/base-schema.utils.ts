...
\`\`\`text
Here is an OpenAPI schema for the ClientVault REST API:\n${serverUrl}/rest/open-api/core?token=${token ?? '<your_token>'}
...
`,
      termsOfService:
        'https://github.com/clientvaulthq/clientvault?tab=coc-ov-file#readme',
      contact: {
        email: 'felix@clientvault.com',
      },
      license: {
        name: 'AGPL-3.0',
        url: 'https://github.com/clientvaulthq/clientvault?tab=License-1-ov-file#readme',
      },
      version: API_Version,
    },
    // Testing purposes
    ...
    externalDocs: {
      description: 'Find out more about **ClientVault**',
      url: 'https://clientvault.com',
    },
