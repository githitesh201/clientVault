...
import ms from 'ms';
import { SendEmailVerificationLinkEmail } from 'clientvault-emails';
...
export class EmailVerificationService {
  ...
  async sendVerificationEmail({
    ...
    if (!this.clientvaultConfigService.get('IS_EMAIL_VERIFICATION_REQUIRED')) {
    ...
    const emailVerificationMsg =
      verificationTrigger === EmailVerificationTrigger.EMAIL_UPDATE
        ...
        : msg`Welcome to ClientVault: Please Confirm Your Email`;
