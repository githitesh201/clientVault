...
import { FieldMetadataType, ObjectRecord } from 'clientvault-shared/types';
import { getLogoUrlFromDomainName, isDefined } from 'clientvault-shared/utils';
...
export class SearchService {
  ...
  getImageIdentifierValue(
    ...
    if (
      ...
      this.clientvaultConfigService.get('ALLOW_REQUESTS_TO_CLIENTVAULT_ICONS')
    ) {
