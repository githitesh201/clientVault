...
export class WorkspaceResolver {
  ...
  hasValidEnterpriseKey(): boolean {
    return isDefined(this.clientvaultConfigService.get('ENTERPRISE_KEY'));
  }
  ...
  isGoogleAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.clientvaultConfigService.get('AUTH_GOOGLE_ENABLED')
    );
  }
  ...
  isMicrosoftAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.clientvaultConfigService.get('AUTH_MICROSOFT_ENABLED')
    );
  }
  ...
  isPasswordAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.clientvaultConfigService.get('AUTH_PASSWORD_ENABLED')
    );
  }
