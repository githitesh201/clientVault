...
export const getSessionStorageOptions = (
  ...
  const SERVER_URL = clientvaultConfigService.get('SERVER_URL');

  const appSecret = clientvaultConfigService.get('APP_SECRET');
  ...
  switch (cacheStorageType) {
    ...
    case CacheStorageType.Redis: {
      const connectionString = clientvaultConfigService.get('REDIS_URL');
