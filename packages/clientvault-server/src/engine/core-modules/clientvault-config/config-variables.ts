...
import { type AwsRegion } from 'src/engine/core-modules/clientvault-config/interfaces/aws-region.interface';
...
import { CastToLogLevelArray } from 'src/engine/core-modules/clientvault-config/decorators/cast-to-log-level-array.decorator';
import { CastToMeterDriverArray } from 'src/engine/core-modules/clientvault-config/decorators/cast-to-meter-driver.decorator';
import { CastToPositiveNumber } from 'src/engine/core-modules/clientvault-config/decorators/cast-to-positive-number.decorator';
import { CastToTypeORMLogLevelArray } from 'src/engine/core-modules/clientvault-config/decorators/cast-to-typeorm-log-level-array.decorator';
import { CastToUpperSnakeCase } from 'src/engine/core-modules/clientvault-config/decorators/cast-to-upper-snake-case.decorator';
import { ConfigVariablesMetadata } from 'src/engine/core-modules/clientvault-config/decorators/config-variables-metadata.decorator';
import { IsAWSRegion } from 'src/engine/core-modules/clientvault-config/decorators/is-aws-region.decorator';
import { IsDuration } from 'src/engine/core-modules/clientvault-config/decorators/is-duration.decorator';
import { IsOptionalOrEmptyString } from 'src/engine/core-modules/clientvault-config/decorators/is-optional-or-empty-string.decorator';
import { IsStrictlyLowerThan } from 'src/engine/core-modules/clientvault-config/decorators/is-strictly-lower-than.decorator';
import { IsClientVaultSemVer } from 'src/engine/core-modules/clientvault-config/decorators/is-clientvault-semver.decorator';
import { ConfigVariableType } from 'src/engine/core-modules/clientvault-config/enums/config-variable-type.enum';
import { ConfigVariablesGroup } from 'src/engine/core-modules/clientvault-config/enums/config-variables-group.enum';
import {
  ConfigVariableException,
  ConfigVariableExceptionCode,
} from 'src/engine/core-modules/clientvault-config/clientvault-config.exception';
...
export class ConfigVariables {
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.OTHER,
    description:
      "Enable or disable requests to clientvault-icons to get companies' icons",
    type: ConfigVariableType.BOOLEAN,
  })
  ALLOW_REQUESTS_TO_CLIENTVAULT_ICONS = true;
  ...
  EMAIL_FROM_NAME = 'Felix from ClientVault';
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.SERVER_CONFIG,
    description: 'ClientVault server version',
    type: ConfigVariableType.STRING,
    isEnvOnly: true,
  })
