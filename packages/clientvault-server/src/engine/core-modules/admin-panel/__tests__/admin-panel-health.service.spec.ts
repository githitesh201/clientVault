...
describe('AdminPanelHealthService', () => {
  ...
  let clientvaultConfigService: jest.Mocked<ClientVaultConfigService>;
  ...
  beforeEach(async () => {
    ...
    clientvaultConfigService = { get: jest.fn() } as any;
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: ClientVaultConfigService, useValue: clientvaultConfigService },
      ],
    }).compile();
