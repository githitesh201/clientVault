...
const ClientVaultConfigServiceGetAllMock = jest.fn();
const ClientVaultConfigServiceGetVariableWithMetadataMock = jest.fn();
const mockHttpClientGet = jest.fn();
const mockGetHttpClient = jest.fn().mockReturnValue({ get: mockHttpClientGet });

jest.mock(
  'src/engine/core-modules/clientvault-config/constants/config-variables-group-metadata',
  () => ({
...
describe('AdminPanelService', () => {
        ...
        },
        {
          ...
          useValue: {
            getWorkspaceUrls: jest.fn().mockReturnValue({
              customUrl: undefined,
              subdomainUrl: 'https://clientvault.clientvault.com',
            }),
          },
        },
        {
          provide: ClientVaultConfigService,
          useValue: {
            getAll: ClientVaultConfigServiceGetAllMock,
            getVariableWithMetadata:
              ClientVaultConfigServiceGetVariableWithMetadataMock,
          },
        },
        {
  ...
  describe('getConfigVariablesGrouped', () => {
    it('should correctly group and sort config variables', () => {
      ClientVaultConfigServiceGetAllMock.mockReturnValue({
        SERVER_URL: {
  ...
  describe('getVersionInfo', () => {
    ...
    beforeEach(() => {
      ...
      service['clientvaultConfigService'].get = mockEnvironmentGet;
    });
  ...
  describe('getConfigVariable', () => {
    it('should return config variable with all fields', () => {
      ClientVaultConfigServiceGetVariableWithMetadataMock.mockReturnValue({
        value: 'test-value',
        metadata: {
          group: 'SERVER_CONFIG',
    ...
    it('should throw error when variable not found', () => {
      ClientVaultConfigServiceGetVariableWithMetadataMock.mockReturnValue(undefined);
