...
import { PermissionFlagType } from 'clientvault-shared/constants';
...
import { ConfigVariableGraphqlApiExceptionFilter } from 'src/engine/core-modules/clientvault-config/filters/config-variable-graphql-api-exception.filter';
...
export class AdminPanelResolver {
  ...
  async getDatabaseConfigVariable(
    ...
    this.clientvaultConfigService.validateConfigVariableExists(key as string);
  ...
  async createDatabaseConfigVariable(
    ...
    await this.clientvaultConfigService.set(key, value);
  ...
  async updateDatabaseConfigVariable(
    ...
    await this.clientvaultConfigService.update(key, value);
  ...
  async deleteDatabaseConfigVariable(
    ...
    await this.clientvaultConfigService.delete(key);
