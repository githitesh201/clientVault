...
export class SearchHelpCenterTool implements Tool {
  description =
    'Search ClientVault documentation and help center to find information about features, setup, usage, and troubleshooting.';
  ...
  async execute(
    ...
    try {
      const MINTLIFY_API_KEY = this.clientvaultConfigService.get('MINTLIFY_API_KEY');
      const MINTLIFY_SUBDOMAIN =
        this.clientvaultConfigService.get('MINTLIFY_SUBDOMAIN');
      ...
      const endpoint = useDirectApi
        ...
        : 'https://clientvault-help-search.com/search/clientvault';
