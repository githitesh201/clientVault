...
import { type DeepPartialWithNestedRelationFields } from 'src/engine/clientvault-orm/entity-manager/types/deep-partial-entity-with-nested-relation-fields.type';
...
import { getEntityTarget } from 'src/engine/clientvault-orm/entity-manager/utils/get-entity-target';
...
import { type GlobalWorkspaceDataSource } from 'src/engine/clientvault-orm/global-workspace-datasource/global-workspace-datasource';
import {
  type OperationType,
  validateOperationIsPermittedOrThrow,
} from 'src/engine/clientvault-orm/repository/permissions.utils';
import { WorkspaceSelectQueryBuilder } from 'src/engine/clientvault-orm/repository/workspace-select-query-builder';
import { WorkspaceRepository } from 'src/engine/clientvault-orm/repository/workspace.repository';
import { getWorkspaceContext } from 'src/engine/clientvault-orm/storage/orm-workspace-context.storage';
import { type RolePermissionConfig } from 'src/engine/clientvault-orm/types/role-permission-config';
import { computePermissionIntersection } from 'src/engine/clientvault-orm/utils/compute-permission-intersection.util';
