...
import { QUERY_MAX_RECORDS } from 'clientvault-shared/constants';
...
import { type QueryDeepPartialEntityWithNestedRelationFields } from 'src/engine/clientvault-orm/entity-manager/types/query-deep-partial-entity-with-nested-relation-fields.type';
import { type RelationConnectQueryConfig } from 'src/engine/clientvault-orm/entity-manager/types/relation-connect-query-config.type';
import { type RelationDisconnectQueryFieldsByEntityIndex } from 'src/engine/clientvault-orm/entity-manager/types/relation-nested-query-fields-by-entity-index.type';
import { type WorkspaceEntityManager } from 'src/engine/clientvault-orm/entity-manager/workspace-entity-manager';
...
import { FilesFieldSync } from 'src/engine/clientvault-orm/field-operations/files-field-sync/files-field-sync';
import { RelationNestedQueries } from 'src/engine/clientvault-orm/field-operations/relation-nested-queries/relation-nested-queries';
import { validateQueryIsPermittedOrThrow } from 'src/engine/clientvault-orm/repository/permissions.utils';
import { type WorkspaceDeleteQueryBuilder } from 'src/engine/clientvault-orm/repository/workspace-delete-query-builder';
import { WorkspaceSelectQueryBuilder } from 'src/engine/clientvault-orm/repository/workspace-select-query-builder';
...
import { formatData } from 'src/engine/clientvault-orm/utils/format-data.util';
...
import { validateRLSPredicatesForRecords } from 'src/engine/clientvault-orm/utils/validate-rls-predicates-for-records.util';
    ...
    try {
      ...
      if (before.length > QUERY_MAX_RECORDS) {
        throw new ClientVaultORMException(
          ...
          ClientVaultORMExceptionCode.TOO_MANY_RECORDS_TO_UPDATE,
          {
      ...
      throw await computeClientVaultORMException(
        error,
        objectMetadata,
