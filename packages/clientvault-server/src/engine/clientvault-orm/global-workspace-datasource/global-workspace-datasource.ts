import { type ObjectsPermissionsByRoleId } from 'clientvault-shared/types';
...
import { WorkspaceEntityManager } from 'src/engine/clientvault-orm/entity-manager/workspace-entity-manager';
import { type WorkspaceQueryRunner } from 'src/engine/clientvault-orm/query-runner/workspace-query-runner';
import { type WorkspaceRepository } from 'src/engine/clientvault-orm/repository/workspace.repository';
