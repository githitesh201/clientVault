...
By submitting your Pull Request, you acknowledge that you agree with the terms of our [Contributor License Agreement](https://github.com/clientvaulthq/clientvault/blob/main/.github/CLA.md).`,
    ),
  );
}
