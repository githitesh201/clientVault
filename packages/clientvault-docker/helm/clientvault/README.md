# ClientVault Helm Chart

Deploy ClientVault CRM on Kubernetes with server, worker, PostgreSQL, and Redis components.
...
helm install my-clientvault ./packages/clientvault-docker/helm/clientvault \
  --namespace clientvaultcrm --create-namespace
```
...
- Database `clientvault` and schema `core` are created automatically by server init container
...
```bash
helm lint ./packages/clientvault-docker/helm/clientvault
helm template my-clientvault ./packages/clientvault-docker/helm/clientvault
helm plugin install https://github.com/quintush/helm-unittest
helm unittest ./packages/clientvault-docker/helm/clientvault
```
...
helm install my-clientvault ./packages/clientvault-docker/helm/clientvault -f values-secrets.yaml
```
