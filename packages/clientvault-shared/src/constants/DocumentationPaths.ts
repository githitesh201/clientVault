 ...
 *                              |___/
 *
 * This file is generated from packages/clientvault-docs/navigation/base-structure.json
...
export const DOCUMENTATION_PATHS = {
  ...
  CLIENTVAULT_UI_DISPLAY_APP_TOOLTIP: '/clientvault-ui/display/app-tooltip',
  CLIENTVAULT_UI_DISPLAY_CHECKMARK: '/clientvault-ui/display/checkmark',
  CLIENTVAULT_UI_DISPLAY_CHIP: '/clientvault-ui/display/chip',
  CLIENTVAULT_UI_DISPLAY_ICONS: '/clientvault-ui/display/icons',
  CLIENTVAULT_UI_DISPLAY_SOON_PILL: '/clientvault-ui/display/soon-pill',
  CLIENTVAULT_UI_DISPLAY_TAG: '/clientvault-ui/display/tag',
  CLIENTVAULT_UI_INPUT_BLOCK_EDITOR: '/clientvault-ui/input/block-editor',
  CLIENTVAULT_UI_INPUT_BUTTONS: '/clientvault-ui/input/buttons',
  CLIENTVAULT_UI_INPUT_CHECKBOX: '/clientvault-ui/input/checkbox',
  CLIENTVAULT_UI_INPUT_COLOR_SCHEME: '/clientvault-ui/input/color-scheme',
  CLIENTVAULT_UI_INPUT_ICON_PICKER: '/clientvault-ui/input/icon-picker',
  CLIENTVAULT_UI_INPUT_IMAGE_INPUT: '/clientvault-ui/input/image-input',
  CLIENTVAULT_UI_INPUT_RADIO: '/clientvault-ui/input/radio',
  CLIENTVAULT_UI_INPUT_SELECT: '/clientvault-ui/input/select',
  CLIENTVAULT_UI_INPUT_TEXT: '/clientvault-ui/input/text',
  CLIENTVAULT_UI_INPUT_TOGGLE: '/clientvault-ui/input/toggle',
  CLIENTVAULT_UI_INTRODUCTION: '/clientvault-ui/introduction',
  CLIENTVAULT_UI_NAVIGATION: '/clientvault-ui/navigation',
  CLIENTVAULT_UI_NAVIGATION_BREADCRUMB: '/clientvault-ui/navigation/breadcrumb',
  CLIENTVAULT_UI_NAVIGATION_LINKS: '/clientvault-ui/navigation/links',
  CLIENTVAULT_UI_NAVIGATION_MENU_ITEM: '/clientvault-ui/navigation/menu-item',
  CLIENTVAULT_UI_NAVIGATION_NAVIGATION_BAR: '/clientvault-ui/navigation/navigation-bar',
  CLIENTVAULT_UI_NAVIGATION_STEP_BAR: '/clientvault-ui/navigation/step-bar',
  CLIENTVAULT_UI_PROGRESS_BAR: '/clientvault-ui/progress-bar',
  ...
  USER_GUIDE_CALENDAR_EMAILS_HOW_TOS_CAN_I_BOOK_MEETINGS_FROM_CLIENTVAULT:
    '/user-guide/calendar-emails/how-tos/can-i-book-meetings-from-clientvault',
  USER_GUIDE_CALENDAR_EMAILS_HOW_TOS_CAN_I_SEND_EMAILS_FROM_CLIENTVAULT:
    '/user-guide/calendar-emails/how-tos/can-i-send-emails-from-clientvault',
  ...
  USER_GUIDE_GETTING_STARTED_CAPABILITIES_WHAT_IS_CLIENTVAULT:
    '/user-guide/getting-started/capabilities/what-is-clientvault',
  ...
  USER_GUIDE_GETTING_STARTED_HOW_TOS_NAVIGATE_AROUND_CLIENTVAULT:
    '/user-guide/getting-started/how-tos/navigate-around-clientvault',
  ...
  USER_GUIDE_WORKFLOWS_HOW_TOS_CONNECT_TO_OTHER_TOOLS_BRING_PRODUCT_DATA_IN_CLIENTVAULT:
    '/user-guide/workflows/how-tos/connect-to-other-tools/bring-product-data-in-clientvault',
  USER_GUIDE_WORKFLOWS_HOW_TOS_CONNECT_TO_OTHER_TOOLS_BRING_TYPEFORM_SUBMISSIONS_IN_CLIENTVAULT:
    '/user-guide/workflows/how-tos/connect-to-other-tools/bring-typeform-submissions-in-clientvault',
  USER_GUIDE_WORKFLOWS_HOW_TOS_CONNECT_TO_OTHER_TOOLS_GENERATE_PDF_FROM_CLIENTVAULT:
    '/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault',
  USER_GUIDE_WORKFLOWS_HOW_TOS_CONNECT_TO_OTHER_TOOLS_GENERATE_QUOTE_OR_INVOICE_FROM_CLIENTVAULT:
    '/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-clientvault',
