...
describe('buildSignedPath', () => {
  ...
  it('should ignore absolute https urls', () => {
    expect(
      buildSignedPath({
        path: 'https://clientvaulthq.github.io/placeholder-images/workspaces/clientvault-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'https://clientvaulthq.github.io/placeholder-images/workspaces/clientvault-logo.png',
    );
  });
  ...
  it('should ignore absolute http urls', () => {
    expect(
      buildSignedPath({
        path: 'http://clientvaulthq.github.io/placeholder-images/workspaces/clientvault-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'http://clientvaulthq.github.io/placeholder-images/workspaces/clientvault-logo.png',
    );
  });
});
