...
import reactConfig from '../clientvault-eslint-rules/eslint.config.react.mjs';
...
export default [
  ...
  // TypeScript project-specific configuration
  {
    ...
    rules: {
      // Override import restrictions for clientvault-ui
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            ...
            {
              group: ['@lingui/*'],
              message: 'Lingui should not be used in clientvault-ui. Pass translatable strings as props from clientvault-front instead.',
            },
          ],
        },
      ],
      ...
      // Disable lingui rules for clientvault-ui - translations should be handled in clientvault-front
