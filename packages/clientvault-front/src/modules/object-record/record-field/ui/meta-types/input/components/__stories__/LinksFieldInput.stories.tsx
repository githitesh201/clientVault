...
export const WithSecondaryLinks: Story = {
  args: {
    value: {
      ...
      secondaryLinks: [
        {
          url: 'https://docs.clientvault.com',
          label: 'Documentation',
        },
        {
          url: 'https://github.com/clientvaulthq/clientvault',
          label: 'GitHub',
        },
      ],
    },
...
export const CreatePrimaryLink: Story = {
  play: async ({ canvasElement }) => {
    ...
    const input = await canvas.findByPlaceholderText('URL');
    await userEvent.type(input, 'https://www.clientvault.com{enter}');

    const linkDisplay = await canvas.findByText('clientvault.com');
...
export const AddSecondaryLink: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const input = await canvas.findByPlaceholderText('URL');
    await userEvent.type(input, 'https://docs.clientvault.com{enter}');

    const secondaryLink = await canvas.findByText('docs.clientvault.com');
...
export const DeletePrimaryLink: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const listItemToDelete = await canvas.findByText('ClientVault Website');
...
export const DeletePrimaryLinkAndUseSecondaryLinkAsTheNewPrimaryLink: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const oldPrimaryLink = canvas.queryByText('ClientVault Website');
