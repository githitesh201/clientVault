...
export const useClientConfig = (): UseClientConfigResult => {
  ...
  const setAllowRequestsToClientVaultIcons = useSetRecoilState(
  ...
  const fetchClientConfig = useCallback(async () => {
    ...
    try {
      ...
      setAllowRequestsToClientVaultIcons(clientConfig?.allowRequestsToClientVaultIcons);
    ...
    setSentryConfig,
    setSupportChat,
    setAllowRequestsToClientVaultIcons,
    store,
  ]);
