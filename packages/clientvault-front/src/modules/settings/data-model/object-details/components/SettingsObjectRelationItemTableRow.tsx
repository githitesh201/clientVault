...
import { FieldMetadataType, SettingsPath } from 'clientvault-shared/types';
import { getSettingsPath, isDefined } from 'clientvault-shared/utils';
import { IconChevronRight, useIcons } from 'clientvault-ui/display';
import { UndecoratedLink } from 'clientvault-ui/navigation';
...
export const SettingsObjectRelationItemTableRow = ({
  ...
  // eslint-disable-next-line clientvault/no-navigate-prefer-link
