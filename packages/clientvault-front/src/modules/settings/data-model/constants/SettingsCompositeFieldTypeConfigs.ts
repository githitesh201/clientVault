...
import {
  ...
  CurrencyCode,
} from 'clientvault-shared/constants';
import { ConnectedAccountProvider } from 'clientvault-shared/types';
import {
...
//TODO : isIncludedInUniqueConstraint refactor - https://github.com/clientvaulthq/core-team-issues/issues/1097
...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.EMAILS]: {
    ...
    exampleValues: [
      {
        primaryEmail: 'tim@clientvault.com',
        additionalEmails: [
          'tim@clientvault.com',
          'timapple@clientvault.com',
          'johnappletim@clientvault.com',
        ],
      },
      {
        primaryEmail: 'jane@clientvault.com',
        additionalEmails: ['jane@clientvault.com', 'jane.doe@clientvault.com'],
      },
      {
        primaryEmail: 'john@clientvault.com',
        additionalEmails: ['john.doe@clientvault.com'],
      },
    ],
    category: 'Basic',
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'clientvault.com',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'clientvault.com', label: 'ClientVault' }],
      },
      {
        primaryLinkUrl: 'github.com/clientvaulthq/clientvault',
        primaryLinkLabel: 'ClientVault Repo',
        secondaryLinks: [{ url: 'clientvault.com', label: '' }],
      },
      {
