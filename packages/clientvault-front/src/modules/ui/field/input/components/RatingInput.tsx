...
import { IconClientVaultStarFilled } from 'clientvault-ui/display';
import { THEME_COMMON, ThemeContext } from 'clientvault-ui/theme';
    ...
    >
      {RATING_VALUES.map((value, index) => {
        ...
        return (
          ...
          >
            <IconClientVaultStarFilled size={iconSizeMd} />
          </StyledRatingIconContainer>
        );
      })}
    </StyledContainer>
