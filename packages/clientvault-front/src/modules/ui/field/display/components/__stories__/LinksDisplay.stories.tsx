...
import { ComponentDecorator } from 'clientvault-ui/testing';
  ...
  args: {
    value: {
      ...
      secondaryLinks: [
        ...
        { url: 'https://www.clientvault.com', label: 'Valid Link' },
      ],
    },
  },
  play: async ({ canvasElement }) => {
    ...
    expect(validLink).toHaveAttribute('href', 'https://www.clientvault.com');
...
export const SingleLink: Story = {
  args: {
    value: {
      primaryLinkUrl: 'https://www.clientvault.com',
      primaryLinkLabel: 'ClientVault Website',
      secondaryLinks: null,
    },
  },
  play: async ({ canvasElement }) => {
    ...
    expect(link).toHaveAttribute('href', 'https://www.clientvault.com');
    expect(link).toHaveTextContent('ClientVault Website');
...
export const MultipleLinks: Story = {
  args: {
    value: {
      ...
      primaryLinkLabel: 'ClientVault Website',
      secondaryLinks: [
        { url: 'https://docs.clientvault.com', label: 'Documentation' },
        { url: 'https://blog.clientvault.com', label: 'Blog' },
      ],
    },
  },
  play: async ({ canvasElement }) => {
    ...
    const primaryLink = await canvas.findByText('ClientVault Website');
    expect(primaryLink).toBeVisible();
    expect(primaryLink).toHaveAttribute('href', 'https://www.clientvault.com');

    const docsLink = await canvas.findByText('Documentation');
    expect(docsLink).toBeVisible();
    expect(docsLink).toHaveAttribute('href', 'https://docs.clientvault.com');

    const blogLink = await canvas.findByText('Blog');
    expect(blogLink).toBeVisible();
    expect(blogLink).toHaveAttribute('href', 'https://blog.clientvault.com');
  },
};
...
export const SocialMediaLinks: Story = {
  args: {
    value: {
      primaryLinkUrl: 'https://www.linkedin.com/company/clientvault',
      primaryLinkLabel: 'ClientVault on LinkedIn',
      secondaryLinks: [
        { url: 'https://twitter.com/clientvaultcrm', label: 'ClientVault on Twitter' },
      ],
    },
  },
  play: async ({ canvasElement }) => {
    ...
    const linkedinLink = await canvas.findByText('clientvault');
    expect(linkedinLink).toBeVisible();
    expect(linkedinLink).toHaveAttribute(
      'href',
      'https://www.linkedin.com/company/clientvault',
    );

    const twitterLink = await canvas.findByText('@clientvaultcrm');
    expect(twitterLink).toBeVisible();
    expect(twitterLink).toHaveAttribute(
      'href',
      'https://twitter.com/clientvaultcrm',
    );
  },
};
