...
import { AppPath, ConnectedAccountProvider } from 'clientvault-shared/types';
import { IconGoogle, IconMicrosoft } from 'clientvault-ui/display';
import { MainButton } from 'clientvault-ui/input';
import { ClickToActionLink } from 'clientvault-ui/navigation';
import {
...
export const SyncEmails = () => {
  ...
  return (
    <Modal.Content isVerticalCentered isHorizontalCentered>
      ...
      <SubTitle>
        {t`Sync your Emails and Calendar with ClientVault. Choose your privacy settings.`}
      </SubTitle>
