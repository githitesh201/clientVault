...
import { Button, CodeEditor } from 'clientvault-ui/input';
  ...
  const options = [
    {
      ...
      value: 'core-schema',
      Icon: IconDatabase,
      content: generateMcpContent('/mcp', 'clientvault'),
    },
    {
      label: t`Metadata Schema`,
      value: 'metadata-schema',
      Icon: IconSitemap,
      content: generateMcpContent('/mcp/metadata', 'clientvault-metadata'),
    },
  ];
