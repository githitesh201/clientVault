...
export default defineConfig(({ command, mode }) => {
  ...
  return {
    root: __dirname,
    cacheDir: '../../node_modules/.vite/packages/clientvault-front',
    ...
    resolve: {
      alias: {
        ...
        // https://github.com/clientvaulthq/clientvault/pull/10782/files
        // This will likely be migrated to clientvault-ui package when built separately
