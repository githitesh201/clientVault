...
import { WhatIsClientVault } from 'src/components/WhatIsClientVault';
import { capitalize } from 'src/utils/capitalize';
import { createI18nInstance } from 'src/utils/i18n.utils';
import { type APP_LOCALES } from 'clientvault-shared/translations';
import { getImageAbsoluteURI } from 'clientvault-shared/utils';
...
export const SendInviteLinkEmail = ({
  ...
  return (
    <BaseEmail width={333} locale={locale}>
      <Title value={i18n._('Join your team on ClientVault')} />
      <MainText>
        <Trans
