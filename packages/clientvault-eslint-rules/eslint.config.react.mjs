...
const clientvaultRules = await nxPlugin.loadWorkspaceRules('packages/clientvault-eslint-rules');
...
export default [
  ...
  // TypeScript specific configuration
  {
    ...
    rules: {
        ...
        'error',
        {
          patterns: [
            ...
            },
            {
              ...
              message: 'Please import icons from `clientvault-ui`',
            },
            {
              group: ['react-hotkeys-web-hook'],
              importNames: ['useHotkeys'],
              message: 'Please use the custom wrapper: `useScopedHotkeys` from `clientvault-ui`',
            },
            {
              group: ['lodash'],
      ...
      'clientvault/effect-components': 'error',
      'clientvault/no-hardcoded-colors': 'error',
      'clientvault/matching-state-variable': 'error',
      'clientvault/sort-css-properties-alphabetically': 'error',
      'clientvault/styled-components-prefixed-with-styled': 'error',
      'clientvault/no-state-useref': 'error',
      'clientvault/component-props-naming': 'error',
      'clientvault/explicit-boolean-predicates-in-if': 'error',
      'clientvault/use-getLoadable-and-getValue-to-get-atoms': 'error',
      'clientvault/useRecoilCallback-has-dependency-array': 'error',
      'clientvault/no-navigate-prefer-link': 'error',
    },
  },
  ...
  // Constants files
  {
    ...
    rules: {
      ...
      'clientvault/max-consts-per-file': ['error', { max: 1 }],
    },
  },
