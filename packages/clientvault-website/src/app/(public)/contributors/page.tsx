...
import { CLIENTVAULT_TEAM_MEMBERS } from '@/shared-utils/listTeamMembers';

export const metadata = {
  title: 'ClientVault - Contributors',
  description:
    'Discover the brilliant minds behind ClientVault.com. Meet our contributors and explore how their expertise contributes to making ClientVault the leading open-source CRM. Join our community today.',
...
const Contributors = async () => {
  ...
  const fitlerContributors = contributors
    ...
    .filter((contributor) => !CLIENTVAULT_TEAM_MEMBERS.includes(contributor.id))
    .map((contributor) => {
