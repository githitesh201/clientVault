...
export async function generateMetadata(props: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    metadataBase: new URL(`https://clientvault.com`),
    title: 'ClientVault - ' + slug,
    description:
      'Explore the impactful contributions of ' +
      slug +
      ' on the ClientVault Github Repo. Discover their merged pull requests, ongoing work, and top ranking. Join and contribute to the #1 Open-Source CRM thriving community!',
    openGraph: {
      images: [`https://clientvault.com/api/contributors/${slug}/og.png`],
    },
  };
}
