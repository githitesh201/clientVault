...
// WARNING: This API is used by clientvault-front, not just by clientvault-website
// Make sure you don't change it without updating clientvault-front at the same time
