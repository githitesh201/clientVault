...
### Documentation Files
- **69 MDX files** copied from clientvault-website to clientvault-docs
...
3. Set subdirectory to `packages/clientvault-docs`
...
6. **Deprecate clientvault-website docs** - Once migration is confirmed working
