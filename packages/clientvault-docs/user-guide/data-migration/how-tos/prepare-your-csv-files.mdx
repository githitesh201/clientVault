...
description: Complete step-by-step guide to format your data for import into ClientVault.
---
...
**This is the most important step.** The sample file shows you the exact column names and format ClientVault expects.
...
ClientVault enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in ClientVault
...
- Must be unique (no duplicates in file or in ClientVault)
...
- Must be unique within your file and in ClientVault
...
### ID Fields
- **Optional**: ClientVault auto-generates IDs if not provided
...
- The parent record must already exist in ClientVault
...
## Step 6: Ensure Fields Exist in ClientVault
