...
description: When and how to use ClientVault's APIs for large-scale data imports.
---

## Overview

ClientVault provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
ClientVault enforces rate limits to ensure system stability:
...
ClientVault supports two API types:
...
- Verify formats match ClientVault's requirements (see [Field Mapping](/user-guide/data-migration/capabilities/field-mapping))
...
- Verify data appears correctly in ClientVault
...
Contact us at [contact@clientvault.com](mailto:contact@clientvault.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
