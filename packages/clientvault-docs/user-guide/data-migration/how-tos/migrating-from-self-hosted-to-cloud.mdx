...
description: Step-by-step guide to migrate your ClientVault self-hosted instance to ClientVault Cloud.
---

## Overview

This guide walks you through migrating your data from a ClientVault self-hosted instance to ClientVault Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.clientvault.com](https://app.clientvault.com) and create a new workspace
...
For complex migrations or large datasets, contact us at [contact@clientvault.com](mailto:contact@clientvault.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
