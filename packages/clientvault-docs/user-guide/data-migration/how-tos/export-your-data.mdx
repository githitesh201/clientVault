...
description: Complete step-by-step guide to exporting data from ClientVault.
---
...
3. **Document field mappings** — note how ClientVault fields map to your target system
