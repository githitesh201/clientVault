---
title: Generate a Quote or Invoice from ClientVault
...
- [Generate a PDF from ClientVault](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — attach generated PDFs to records
