---
title: Generate a PDF from ClientVault
description: Create a workflow to generate and attach a PDF (such as a quote) to a record.
---

Automatically generate or fetch a PDF and attach it to a record in ClientVault. This is commonly used to create quotes, invoices, or reports that are linked to Companies, Opportunities, or other objects.
...
2. Uploading the file to ClientVault
...
- [Generate a Quote or Invoice from ClientVault](/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-clientvault)
