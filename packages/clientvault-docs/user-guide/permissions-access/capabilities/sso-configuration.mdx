...
Single Sign-On (SSO) allows your team members to log into ClientVault using your organization's identity provider. This provides:
...
- Admin access to ClientVault workspace

<Note>
**For self-hosting users willing to set up SSO**, reach out to contact@clientvault.com
</Note>
...
- Remove them from the ClientVault workspace
...
- **Group mapping**: Map IdP groups to ClientVault roles (if available)
- **Offboarding process**: Include ClientVault in your deprovisioning workflow
