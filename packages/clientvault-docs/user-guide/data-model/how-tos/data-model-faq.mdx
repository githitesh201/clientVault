...
description: Frequently asked questions about ClientVault's data model.
---
...
You can rename the label of standard objects (People, Companies, Opportunities), but not their API names. The API names are fixed for consistency across all ClientVault workspaces.
</Accordion>
