...
ClientVault comes with standard objects:
...
Every business works differently. Customizing your data model means you can shape ClientVault around **your** processes instead of forcing yours into a rigid system.

ClientVault offers full flexibility:
...
Identify the main concepts you work with. ClientVault already provides:
