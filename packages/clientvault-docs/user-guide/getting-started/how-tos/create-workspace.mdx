...
description: Follow a step-by-step guide on how to register on ClientVault, choose a subscription plan, and set up your account.
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

## Step 1: Registration
1. Navigate to [ClientVault Sign Up](https://app.clientvault.com).
...
## Support
For queries or help, connect with the dedicated support team at [contact@clientvault.com](mailto:contact@clientvault.com) or send a message on [Discord](https://discord.gg/cx5n4Jzs57).
