---
title: Navigate Around ClientVault
...
The command menu gives you **quick access to actions** in ClientVault. You can access it in two ways:
...
- Create new views
- Access deleted records (ClientVault supports soft and hard deletes)
