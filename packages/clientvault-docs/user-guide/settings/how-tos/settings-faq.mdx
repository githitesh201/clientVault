---
title: Settings FAQ
description: Frequently asked questions about ClientVault settings.
...
To change your email address, please reach out to [contact@clientvault.com](mailto:contact@clientvault.com).
</Accordion>
...
- **Subdomain**: Use a ClientVault subdomain like `yourcompany.clientvault.com`
