...
description: Enable Early Access features in ClientVault.
---
...
<Note>
Early Access features may change based on user feedback. Your input helps us improve ClientVault!
</Note>

## Feature Feedback

Your feedback helps improve ClientVault:
