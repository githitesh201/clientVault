---
title: Pricing Plans
description: Learn about ClientVault's pricing plans and how to switch between them.
---

## Overview

ClientVault offers flexible pricing to fit teams of all sizes, whether you prefer cloud hosting or self-hosting.
...
### Free (Self-Hosted)
Host ClientVault on your own infrastructure at no cost:
