---
title: Discover ClientVault
description: Welcome to ClientVault User Guide, your resources for advanced configurations and best practices.
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={3}>
  <Card href="/user-guide/getting-started/capabilities/what-is-clientvault" img="/images/user-guide/api/api.png">
    <CardTitle>Discover ClientVault</CardTitle>
    Learn what ClientVault is and how it can help your business.
  </Card>
  ...
  <Card href="/user-guide/permissions-access/overview" img="/images/user-guide/permissions/permissions.png">
    ...
    Manage roles and access to ClientVault.
  </Card>

  <Card href="/user-guide/billing/overview" img="/images/user-guide/setup/pricing.png">
    <CardTitle>Billing</CardTitle>
    Understand how ClientVault pricing and billing works.
  </Card>
