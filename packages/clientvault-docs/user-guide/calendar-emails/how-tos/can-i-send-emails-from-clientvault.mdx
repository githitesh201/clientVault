---
title: Can I Send Emails from ClientVault?
description: Information about sending emails directly from ClientVault.
---

## Current Status

ClientVault's email integration is designed to **sync and display** your email history. Emails cannot be composed or sent directly from ClientVault's interface.
...
While you can't send emails manually from ClientVault, you **can send emails automatically using Workflows**. This is useful for:
...
For email sequences and newsletters, we recommend using workflows to connect ClientVault to a dedicated email marketing tool.
...
Native email composition from within ClientVault is on our roadmap. Join our [GitHub discussions](https://github.com/clientvaulthq/clientvault/discussions) to share your use case and help prioritize this feature.
