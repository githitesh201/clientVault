...
description: Nejčastější dotazy k panelům v ClientVault.
---

<AccordionGroup>
  <Accordion title="Mohu vytvářet soukromé panely?">
    Ne, panely jsou nyní viditelné pro všechny, kteří mají přístup do vašeho pracovního prostoru ClientVault. Soukromé panely zatím nejsou k dispozici.
  </Accordion>
  ...
  <Accordion title="Mohu sdílet panely s externími uživateli?">
    Ne, sdílení panelů s uživateli mimo váš pracovní prostor ClientVault (uživatelé mimo ClientVault) zatím není podporováno.
  </Accordion>
