---
title: Nastavení FAQ
description: Často kladené otázky k nastavení ClientVault.
...
<AccordionGroup>
  ...
  <Accordion title="Mohu změnit svou e-mailovou adresu?">
    Chcete-li změnit svou e-mailovou adresu, kontaktujte prosím [contact@clientvault.com](mailto:contact@clientvault.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Mohu přizpůsobit doménu své pracovní oblasti?">
    ...
    * **Poddoména**: Použijte poddoménu ClientVault, například `yourcompany.clientvault.com`
