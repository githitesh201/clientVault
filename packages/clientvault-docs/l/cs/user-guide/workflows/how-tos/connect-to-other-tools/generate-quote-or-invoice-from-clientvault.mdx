---
title: Vytvořte nabídku nebo fakturu z ClientVault
...
* [Vygenerovat PDF z ClientVault](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — připojte vygenerované soubory PDF k záznamům
