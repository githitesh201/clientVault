---
title: Vygenerovat PDF z ClientVault
description: Vytvořte pracovní postup pro generování a připojení PDF (například nabídky) k záznamu.
---

Automaticky vygenerujte nebo získejte PDF a připojte ho k záznamu v ClientVault. To se běžně používá k vytváření nabídek, faktur nebo reportů, které jsou propojené se společnostmi, příležitostmi nebo jinými objekty.
...
2. Nahrání souboru do ClientVault
...
* [Vygenerujte nabídku nebo fakturu z ClientVault](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-clientvault)
