...
description: Sledujte podrobný návod, jak se zaregistrovat na ClientVault, vybrat si plán předplatného a nastavit svůj účet.
---
...
1. Přejděte na [Registrace ClientVault](https://app.clientvault.com).
...
V případě dotazů nebo potřeby pomoci kontaktujte specializovaný tým podpory na [contact@clientvault.com](mailto:contact@clientvault.com) nebo pošlete zprávu na [Discord](https://discord.gg/cx5n4Jzs57).
