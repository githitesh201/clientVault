---
title: Orientace v prostředí ClientVault
...
Nabídka příkazů vám v ClientVault poskytuje **rychlý přístup k akcím**. K němu můžete přistoupit dvěma způsoby:
...
* Přistupujte k smazaným záznamům (ClientVault podporuje logické i trvalé mazání)
