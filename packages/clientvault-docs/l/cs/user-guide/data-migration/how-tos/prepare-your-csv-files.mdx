...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do ClientVault.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který ClientVault očekává.
...
ClientVault vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v ClientVault existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v ClientVault)
...
* Musí být jedinečné v rámci vašeho souboru i v ClientVault
...
* **Odkazy / Štítek odkazu**: `ClientVault`
* **Odkazy / URL odkazu**: `https://clientvault.com`
...
* **Volitelné**: ClientVault automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v ClientVault již existovat
...
## Krok 6: Ujistěte se, že pole v ClientVault existují
