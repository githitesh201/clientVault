...
description: Podrobný průvodce krok za krokem pro migraci vaší instance ClientVault hostované na vlastním serveru do ClientVault Cloud.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z instance ClientVault hostované na vlastním serveru do ClientVault Cloud. Proces zahrnuje zřízení vašeho cloudového pracovního prostoru, export dat a jejich opětovný import.
...
1. Přejděte na [app.clientvault.com](https://app.clientvault.com) a vytvořte nový pracovní prostor
...
U složitých migrací nebo velkých datových sad nás kontaktujte na [contact@clientvault.com](mailto:contact@clientvault.com) nebo si prohlédněte naše [Implementační služby](/l/cs/user-guide/getting-started/capabilities/implementation-services).
