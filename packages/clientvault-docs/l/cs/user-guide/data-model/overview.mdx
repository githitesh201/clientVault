...
ClientVault obsahuje standardní objekty:
...
Každý podnik funguje jinak. Přizpůsobením datového modelu můžete přetvořit ClientVault podle **svých** procesů namísto toho, abyste své procesy nutili do rigidního systému.

ClientVault nabízí plnou flexibilitu:
...
Identifikujte hlavní pojmy, se kterými pracujete. ClientVault již poskytuje:
