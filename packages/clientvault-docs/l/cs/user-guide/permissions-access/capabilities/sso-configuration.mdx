...
Jednotné přihlášení (SSO) umožňuje členům vašeho týmu přihlašovat se do ClientVault pomocí poskytovatele identity vaší organizace. To přináší:
...
* Administrátorský přístup k pracovnímu prostoru ClientVault

<Note>
  **Pro uživatele vlastního hostování, kteří chtějí nastavit SSO**, obraťte se na contact@clientvault.com
</Note>
...
* Odeberte je z pracovního prostoru ClientVault
...
* **Mapování skupin**: Namapujte skupiny z IdP na role v ClientVault (pokud je k dispozici)
* **Proces offboardingu**: Zahrňte ClientVault do svého pracovního postupu deprovisioningu
