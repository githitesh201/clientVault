...
<AccordionGroup>
  <Accordion title="Jaké role jsou ve ClientVault ve výchozím nastavení?">
    ClientVault ve výchozím stavu obsahuje role **Administrátor** a **Člen**. Můžete vytvářet další vlastní role podle potřeb vašeho týmu (např. obchodní zástupce, manažer, uživatel pouze pro čtení).
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Jaká oprávnění k akcím jsou k dispozici?">
    ...
    * **Odeslat e-mail**: Možnost odesílat e-maily z ClientVault
...
<AccordionGroup>
  ...
  <Accordion title="Co je zřizování Just-in-Time (JIT)?">
    Při zřizování JIT se uživatelské účty v ClientVault vytvoří automaticky, když se někdo poprvé přihlásí přes SSO. Automaticky jim je přiřazena výchozí role.
  </Accordion>
