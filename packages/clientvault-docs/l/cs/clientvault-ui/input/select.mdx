...
<Frame>
  <img src="/images/user-guide/what-is-clientvault/20.png" alt="Hlavička" />
</Frame>
      ...
      return (
        <RecoilRoot>
          <Select
            ...
            options={[
              { value: 'option1', label: 'Možnost A', Icon: IconClientVaultStar },
              { value: 'option2', label: 'Možnost B', Icon: IconClientVaultStar },
            ]}
            value="option1"
          />
        </RecoilRoot>
