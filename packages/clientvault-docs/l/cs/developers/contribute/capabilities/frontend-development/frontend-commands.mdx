...
```bash
npx nx run clientvault-front:lint # přidejte --fix pro opravu chyb ve formátování
```
...
```bash
npx nx run clientvault-front:test # spusťte jest testy
npx nx run clientvault-front:storybook:serve:dev # spusťte storybook
npx nx run clientvault-front:storybook:test # spusťte testy # (vyžaduje, aby byl spuštěn yarn storybook:serve:dev)
npx nx run clientvault-front:storybook:coverage # (vyžaduje, aby byl spuštěn yarn storybook:serve:dev)
```
