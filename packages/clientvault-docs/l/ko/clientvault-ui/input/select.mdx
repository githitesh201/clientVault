...
<Frame>
  <img src="/images/user-guide/what-is-clientvault/20.png" alt="헤더" />
</Frame>
      ...
      return (
        <RecoilRoot>
          <Select
            ...
            label="옵션을 선택하세요"
            options={[
              { value: 'option1', label: '옵션 A', Icon: IconClientVaultStar },
              { value: 'option2', label: '옵션 B', Icon: IconClientVaultStar },
            ]}
            value="option1"
          />
        </RecoilRoot>
