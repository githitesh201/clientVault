---
title: ClientVault로 제품 데이터 가져오기
description: 일정에 따라 데이터 웨어하우스의 제품 카탈로그 데이터를 CRM으로 동기화하세요.
---

이 패턴을 사용하여 데이터 웨어하우스(예: Snowflake, BigQuery, PostgreSQL)의 제품 데이터와 ClientVault를 동기화 상태로 유지하세요.
...
4. **Iterator**: 각 제품을 순회
5. **레코드 업서트**: ClientVault에서 생성 또는 업데이트
