---
title: ClientVault에서 견적서 또는 인보이스 생성
...
* [ClientVault에서 PDF 생성](/l/ko/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — 생성된 PDF를 레코드에 첨부
