...
description: Aflați despre planurile tarifare ale ClientVault și cum să comutați între ele.
---

## Prezentare generală

ClientVault oferă prețuri flexibile care se potrivesc echipelor de orice dimensiune, fie că preferați găzduirea în cloud sau autogăzduirea.
...
Găzduiți ClientVault pe propria infrastructură, fără costuri:
...
* **Funcționalități premium**: integrare SSO și permisiuni la nivel de rând
* Asistență din partea echipei ClientVault
