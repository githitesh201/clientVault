...
description: Când și cum să utilizați API-urile ClientVault pentru importuri de date la scară mare.
---

## Prezentare generală

ClientVault oferă atât **GraphQL**, cât și **API-uri REST** pentru importul programatic de date. Utilizați API-ul când importul CSV nu este practic pentru volumul dvs. de date sau când aveți nevoie de importuri automate, recurente.
...
ClientVault impune limitări de rată pentru a asigura stabilitatea sistemului:
...
ClientVault acceptă două tipuri de API:
...
* Verificați că formatele corespund cerințelor ClientVault (consultați [Maparea câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verificați că datele apar corect în ClientVault
...
Contactați-ne la [contact@clientvault.com](mailto:contact@clientvault.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
