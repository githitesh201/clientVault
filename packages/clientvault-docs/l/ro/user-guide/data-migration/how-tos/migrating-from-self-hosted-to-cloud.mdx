...
description: Ghid pas cu pas pentru migrarea instanței ClientVault auto-găzduite la ClientVault Cloud.
---

## Prezentare generală

Acest ghid vă ghidează prin migrarea datelor dvs. dintr-o instanță ClientVault auto-găzduită către ClientVault Cloud. Procesul presupune configurarea spațiului dvs. de lucru în cloud, exportarea datelor și reimportarea acestora.
...
1. Accesați [app.clientvault.com](https://app.clientvault.com) și creați un nou spațiu de lucru
...
Pentru migrarea complexă sau seturi mari de date, contactați-ne la [contact@clientvault.com](mailto:contact@clientvault.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
