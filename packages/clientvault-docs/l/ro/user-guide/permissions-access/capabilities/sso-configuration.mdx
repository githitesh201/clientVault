...
Single Sign-On (SSO) le permite membrilor echipei dvs. să se autentifice în ClientVault folosind furnizorul de identitate al organizației dvs. Acest lucru oferă:
...
* Acces de administrator la spațiul de lucru ClientVault

<Note>
  **Pentru utilizatorii care se auto-găzduiesc și doresc să configureze SSO**, contactați contact@clientvault.com
</Note>
...
* Eliminați-i din spațiul de lucru ClientVault
...
* **Maparea grupurilor**: Mapați grupurile IdP la rolurile ClientVault (dacă este disponibilă)
* **Proces de offboarding**: Includeți ClientVault în fluxul dvs. de deprovisionare
