...
description: Întrebări frecvente despre setările ClientVault.
...
<AccordionGroup>
  ...
  <Accordion title="Pot să îmi schimb adresa de e-mail?">
    Pentru a vă schimba adresa de e-mail, vă rugăm să ne contactați la [contact@clientvault.com](mailto:contact@clientvault.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Pot personaliza domeniul spațiului meu de lucru?">
    ...
    * **Subdomeniu**: Folosiți un subdomeniu ClientVault, de exemplu `yourcompany.clientvault.com`
