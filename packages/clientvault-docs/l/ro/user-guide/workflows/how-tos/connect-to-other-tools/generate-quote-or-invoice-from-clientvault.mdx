---
title: Generați o ofertă sau o factură din ClientVault
...
* [Generați un PDF din ClientVault](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — atașați PDF-uri generate la înregistrări
