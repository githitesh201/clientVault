...
```bash
npx nx run clientvault-front:lint # utilizați --fix pentru a corecta erorile de lint
```
...
```bash
npx nx run clientvault-front:test # rulați teste jest
npx nx run clientvault-front:storybook:serve:dev # rulați storybook
npx nx run clientvault-front:storybook:test # rulați testele # (are nevoie de yarn storybook:serve:dev pentru a rula)
npx nx run clientvault-front:storybook:coverage # (are nevoie de yarn storybook:serve:dev pentru a rula)
```
