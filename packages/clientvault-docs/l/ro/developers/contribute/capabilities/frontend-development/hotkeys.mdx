...
În `clientvault-front` totuși, s-ar putea să aveți conflicte între aceleași comenzi rapide folosite în componente diferite, montate simultan.
...
## Cum detectezi scurtăturile de la tastatură în practică?
