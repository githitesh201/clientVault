...
Los indicadores de característica se usan para ocultar características experimentales. Para ClientVault, se configuran a nivel de espacio de trabajo y no a nivel de usuario.
