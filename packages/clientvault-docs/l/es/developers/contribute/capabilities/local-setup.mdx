...
description: La guía para los colaboradores (o desarrolladores curiosos) que quieren ejecutar ClientVault localmente.
---
...
<Tabs>
  <Tab title="Linux y MacOS">
    Antes de que puedas instalar y usar ClientVault, asegúrate de instalar lo siguiente en tu computadora:
...
ClientVault requiere un caché de redis para proporcionar el mejor rendimiento
...
## Paso 8: Use ClientVault

**Frontend**

El frontend de ClientVault estará ejecutándose en [http://localhost:3001](http://localhost:3001).
Puede iniciar sesión usando la cuenta demo por defecto: `tim@apple.dev` (contraseña: `tim@apple.dev`)

**Backend**

* El servidor de ClientVault estará operativo en [http://localhost:3000](http://localhost:3000)
