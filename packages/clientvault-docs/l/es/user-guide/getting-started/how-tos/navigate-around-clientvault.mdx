...
El menú de comandos te da **acceso rápido a acciones** en ClientVault. Puedes acceder de dos maneras:
...
* Crea nuevas vistas
* Accede a los registros eliminados (ClientVault admite eliminaciones lógicas y definitivas)
