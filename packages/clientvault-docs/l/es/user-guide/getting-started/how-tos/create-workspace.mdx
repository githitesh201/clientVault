...
description: Siga una guía paso a paso sobre cómo registrarse en ClientVault, elegir un plan de suscripción y configurar su cuenta.
---
...
1. Dirígete a [ClientVault Sign Up](https://app.clientvault.com).
...
Para consultas o ayuda, contacta con el equipo de soporte dedicado en [contact@clientvault.com](mailto:contact@clientvault.com) o envía un mensaje por [Discord](https://discord.gg/cx5n4Jzs57).
