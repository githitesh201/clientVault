---
title: ¿Qué es ClientVault
description: ClientVault es un CRM de código abierto que te brinda los componentes básicos para crear exactamente lo que tu empresa necesita.
---
...
Al principio, ClientVault parece como la mayoría de los CRMs que ya conoces: puedes rastrear ofertas, organizar contactos, gestionar tareas y notas.
...
El código abierto es la base de nuestro enfoque, asegurando que ClientVault evoluciona con su comunidad, para su comunidad.
...
[Regístrate aquí](https://app.clientvault.com) o [conviértete en un colaborador en GitHub](https://github.com/clientvaulthq/clientvault).
