...
description: Preguntas frecuentes sobre los flujos de trabajo en ClientVault.
---
...
<AccordionGroup>
  ...
  <Accordion title="¿Cuáles son los límites de tasa de los flujos de trabajo?">
    ClientVault tiene dos límites de tasa para garantizar la estabilidad del sistema:
