---
title: Generar una cotización o una factura desde ClientVault
...
* [Generar un PDF desde ClientVault](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — adjuntar los PDF generados a los registros
