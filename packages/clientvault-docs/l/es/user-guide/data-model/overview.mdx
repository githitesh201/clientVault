...
ClientVault incluye objetos estándar:
...
Cada empresa funciona de manera diferente. Personalizar tu modelo de datos significa que puedes adaptar ClientVault a **tus** procesos en lugar de forzar los tuyos en un sistema rígido.

ClientVault ofrece total flexibilidad:
...
Identifica los conceptos principales con los que trabajas. ClientVault ya ofrece:
