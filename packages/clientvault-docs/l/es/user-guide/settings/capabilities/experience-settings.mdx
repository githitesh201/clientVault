...
Personaliza tu experiencia con ClientVault en **Ajustes → Experiencia**.
...
Selecciona tu idioma preferido para la interfaz de ClientVault en el menú desplegable.
