...
description: Guía completa paso a paso para dar formato a tus datos para importarlos en ClientVault.
---
...
**Este es el paso más importante.** El archivo de ejemplo te muestra los nombres de columna y el formato exactos que ClientVault espera.
...
ClientVault exige unicidad en determinados campos. Los duplicados provocarán errores de importación.
...
3. Comprueba si hay duplicados que ya existan en ClientVault
...
* Debe ser único (sin duplicados en el archivo ni en ClientVault)
...
* Debe ser único dentro de tu archivo y en ClientVault
...
* **Enlaces / Etiqueta del enlace**: `ClientVault`
* **Enlaces / URL del enlace**: `https://clientvault.com`
...
* **Opcional**: ClientVault genera IDs automáticamente si no se proporcionan
...
* El registro padre debe existir previamente en ClientVault
...
## Paso 6: Asegúrate de que los campos existan en ClientVault
