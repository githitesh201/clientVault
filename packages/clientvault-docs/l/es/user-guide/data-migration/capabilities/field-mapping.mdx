...
Cuando cargas un archivo, ClientVault analiza las columnas e intenta hacerlas coincidir con los campos existentes.

### Asignación automática

ClientVault intenta hacer coincidir las columnas en función de:
...
<Note>**Consejo rápido:** Exporta algunas filas del objeto que quieres importar. El archivo exportado tendrá los nombres de columna exactos que ClientVault espera, lo que hará que la asignación automática sea fluida durante la importación.</Note>

### Opciones de asignación manual

Para cada columna, puedes:

* **Asignar a un campo**: Selecciona el campo correspondiente de ClientVault desde un menú desplegable
...
Es opcional especificar un `id` durante la importación. ClientVault lo genera automáticamente si no se proporciona.
