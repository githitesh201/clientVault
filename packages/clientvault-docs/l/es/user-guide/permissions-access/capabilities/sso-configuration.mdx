...
El inicio de sesión único (SSO) permite que los miembros de su equipo inicien sesión en ClientVault utilizando el proveedor de identidad de su organización. Esto proporciona:
...
* Acceso de administrador al espacio de trabajo de ClientVault

<Note>
  **Para usuarios de autoalojamiento que deseen configurar SSO**, comuníquese con contact@clientvault.com
</Note>
...
* **Entity ID**: Proporcionado por ClientVault
* **ACS URL**: La URL de retorno para la autenticación
* **Certificado**: Para comunicación segura

#### 4. Introduzca los detalles del proveedor en ClientVault
...
* Elimínelos del espacio de trabajo de ClientVault
...
* **Asignación de grupos**: Asigne los grupos del IdP a roles de ClientVault (si está disponible)
* **Proceso de desvinculación**: Incluya ClientVault en su flujo de trabajo de desaprovisionamiento
