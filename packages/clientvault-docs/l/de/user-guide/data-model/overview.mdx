...
ClientVault enthält Standardobjekte:
...
Jedes Unternehmen arbeitet anders. Die Anpassung Ihres Datenmodells bedeutet, dass Sie ClientVault um **Ihre** Prozesse herum gestalten können, anstatt Ihre in ein starres System zu zwängen.

ClientVault bietet volle Flexibilität:
...
Identifizieren Sie die wichtigsten Konzepte, mit denen Sie arbeiten. ClientVault bietet bereits:
