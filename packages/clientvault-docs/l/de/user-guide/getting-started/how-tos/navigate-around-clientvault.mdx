---
title: In ClientVault navigieren
...
Das Befehlsmenü gibt Ihnen **schnellen Zugriff auf Aktionen** in ClientVault. Sie können es auf zwei Weisen aufrufen:
...
* Auf gelöschte Datensätze zugreifen (ClientVault unterstützt weiches und hartes Löschen)
