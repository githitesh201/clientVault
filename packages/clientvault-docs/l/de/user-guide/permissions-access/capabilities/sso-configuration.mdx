...
Single Sign-On (SSO) ermöglicht es Ihren Teammitgliedern, sich mit dem Identitätsanbieter Ihrer Organisation bei ClientVault anzumelden. Dies bietet:
...
ClientVault unterstützt SSO mit:
...
* Administratorzugriff auf den ClientVault-Arbeitsbereich

<Note>
  **Für Self-Hosting-Nutzer, die SSO einrichten möchten**, wenden Sie sich an contact@clientvault.com
</Note>
...
* Entfernen Sie sie aus dem ClientVault-Arbeitsbereich
...
* **Gruppenzuordnung**: Ordnen Sie IdP-Gruppen ClientVault-Rollen zu (falls verfügbar)
* **Offboarding-Prozess**: Beziehen Sie ClientVault in Ihren Deprovisioning-Workflow ein
