---
title: Ein Angebot oder eine Rechnung aus ClientVault erstellen.
...
* [Ein PDF aus ClientVault generieren](/l/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — generierte PDFs an Datensätze anhängen
