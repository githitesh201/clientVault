---
title: Workflows
description: Erfahren Sie, wie Sie Automatisierungen in ClientVault erstellen.
...
2. **Daten in und aus ClientVault bringen**: Verbinden Sie ClientVault über API-Aufrufe und Webhooks mit Ihrer Datenbank und anderen Werkzeugen.
...
* **Formular**: Eingaben von Benutzern innerhalb der ClientVault-Oberfläche zum Zeitpunkt der Ausführung abfragen
