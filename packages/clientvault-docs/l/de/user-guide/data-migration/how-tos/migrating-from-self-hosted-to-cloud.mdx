...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer selbstgehosteten ClientVault-Instanz zu ClientVault Cloud.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von einer selbstgehosteten ClientVault-Instanz zu ClientVault Cloud. Der Prozess umfasst das Einrichten Ihres Cloud-Arbeitsbereichs, das Exportieren Ihrer Daten und deren erneutes Importieren.
...
1. Gehen Sie zu [app.clientvault.com](https://app.clientvault.com) und erstellen Sie einen neuen Arbeitsbereich
...
Bei komplexen Migrationen oder großen Datenmengen kontaktieren Sie uns unter [contact@clientvault.com](mailto:contact@clientvault.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
