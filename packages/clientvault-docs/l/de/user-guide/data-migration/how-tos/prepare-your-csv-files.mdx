...
description: Vollständige Schritt-für-Schritt-Anleitung zum Formatieren deiner Daten für den Import in ClientVault.
---
...
**Dies ist der wichtigste Schritt.** Die Beispieldatei zeigt dir die exakten Spaltennamen und das Format, das ClientVault erwartet.
...
ClientVault erzwingt die Eindeutigkeit bestimmter Felder. Duplikate führen zu Importfehlern.
...
3. Prüfe auf Duplikate, die in ClientVault bereits existieren
...
* Muss eindeutig sein (keine Duplikate in der Datei oder in ClientVault)
...
* Muss innerhalb deiner Datei und in ClientVault eindeutig sein
...
* **Links / Link-Label**: `ClientVault`
* **Links / Link-URL**: `https://clientvault.com`

Für sekundäre Links verwenden Sie die Spalte **Links / Sekundäre Links**:

```
[{"url":"https://clientvault.com","label":"ClientVault"}]
```
...
* **Optional**: ClientVault erstellt IDs automatisch, wenn sie nicht angegeben werden
...
* Der übergeordnete Datensatz muss bereits in ClientVault vorhanden sein
...
## Schritt 6: Sicherstellen, dass Felder in ClientVault vorhanden sind
