---
title: Preispläne
description: Erfahren Sie mehr über die Preispläne von ClientVault und wie Sie zwischen ihnen wechseln können.
---

## Übersicht

ClientVault bietet flexible Preise, die zu Teams jeder Größe passen – egal, ob Sie Cloud-Hosting oder Selbsthosting bevorzugen.
...
Hosten Sie ClientVault auf Ihrer eigenen Infrastruktur kostenlos:
...
* Alle Pro-Funktionen
* **Premiumfunktionen**: SSO-Integration und Berechtigungen auf Zeilenebene
* Support durch das ClientVault-Team
