...
```bash
npx nx run clientvault-front:lint # Füge --fix hinzu, um Lint-Fehler zu beheben
```
...
```bash
npx nx run clientvault-front:test # führe JEST-Tests aus
npx nx run clientvault-front:storybook:serve:dev # führe Storybook aus
npx nx run clientvault-front:storybook:test # führe Tests aus # benötigt yarn storybook:serve:dev als laufenden Prozess
npx nx run clientvault-front:storybook:coverage # benötigt yarn storybook:serve:dev als laufenden Prozess
```
