...
Komut menüsü, ClientVault'de **eylemlere hızlı erişim** sağlar. İki yöntemle erişebilirsiniz:
...
* Silinen kayıtlara erişin (ClientVault yumuşak ve kalıcı silmeleri destekler)
