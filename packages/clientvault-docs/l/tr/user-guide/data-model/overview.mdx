...
ClientVault, standart nesnelerle birlikte gelir:
...
Her iş farklı çalışır. Veri modelinizi özelleştirmek, süreçlerinizi katı bir sisteme uydurmaya çalışmak yerine ClientVault'yi **sizin** süreçleriniz etrafında şekillendirebilmeniz demektir.

ClientVault tam esneklik sunar:
...
Üzerinde çalıştığınız temel kavramları belirleyin. ClientVault zaten şunları sunar:
