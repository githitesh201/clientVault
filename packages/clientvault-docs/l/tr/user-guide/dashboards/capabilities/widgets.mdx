---
title: Widget'lar
description: ClientVault'deki widget türlerini ve görselleştirme seçeneklerini keşfedin.
---
...
ClientVault, Müşteri İlişkileri Yönetimi (CRM) verilerinizi görselleştirmek için çeşitli widget türleri sunar.
