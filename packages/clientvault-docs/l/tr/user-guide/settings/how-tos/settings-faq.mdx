---
title: Ayarlar SSS
description: ClientVault ayarları hakkında sıkça sorulan sorular.
...
<AccordionGroup>
  ...
  <Accordion title="E-posta adresimi değiştirebilir miyim?">
    E-posta adresinizi değiştirmek için lütfen [contact@clientvault.com](mailto:contact@clientvault.com) ile iletişime geçin.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Çalışma alanı alan adımı özelleştirebilir miyim?">
    ...
    * **Alt alan adı**: `yourcompany.clientvault.com` gibi bir ClientVault alt alan adı kullanın
