...
description: Hangi e-postaların ClientVault'ye içe aktarılacağını kontrol edin.
---

## Genel Bakış

Varsayılan olarak, ClientVault bağlı posta kutunuzdan tüm harici e-postaları senkronize eder. **Klasör seçimi** ve **görünürlük ayarlarını** kullanarak içe aktarılanları sınırlayabilirsiniz.
