...
description: Büyük ölçekli veri içe aktarmaları için ClientVault'nin API'lerini ne zaman ve nasıl kullanacağınız.
---

## Genel Bakış

ClientVault, programatik veri içe aktarma için hem **GraphQL** hem de **REST API'leri** sunar. Veri hacminiz için CSV içe aktarma pratik değilse veya otomatik, yinelenen içe aktarmalara ihtiyacınız varsa API'yi kullanın.
...
ClientVault, sistem kararlılığını sağlamak için hız sınırlarını uygular:
...
ClientVault iki API türünü destekler:
...
* Biçimlerin ClientVault'nin gereksinimlerine uyduğunu doğrulayın (bkz. [Alan Eşleme](/l/tr/user-guide/data-migration/capabilities/field-mapping))
...
* Verilerin ClientVault'de doğru göründüğünü doğrulayın
