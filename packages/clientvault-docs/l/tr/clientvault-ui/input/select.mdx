...
<Frame>
  <img src="/images/user-guide/what-is-clientvault/20.png" alt="Başlık" />
</Frame>
      ...
      return (
        <RecoilRoot>
          <Select
            ...
            options={[
              { value: 'option1', label: 'Seçenek A', Icon: IconClientVaultStar },
              { value: 'option2', label: 'Seçenek B', Icon: IconClientVaultStar },
            ]}
            value="option1"
          />
        </RecoilRoot>
