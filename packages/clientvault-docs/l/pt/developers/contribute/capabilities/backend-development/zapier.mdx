...
Sincronize o ClientVault com mais de 3000 aplicativos usando [Zapier](https://zapier.com/) sem esforço. Automatize tarefas, aumente a produtividade e potencialize seus relacionamentos com clientes!
...
Na pasta `packages/clientvault-zapier`, execute:
