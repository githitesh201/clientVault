...
O ClientVault vem com objetos padrão:
...
Cada empresa trabalha de maneira diferente. Personalizar seu modelo de dados significa que você pode moldar o ClientVault em torno dos **seus** processos, em vez de forçar os seus a caber em um sistema rígido.

O ClientVault oferece total flexibilidade:
...
Identifique os principais conceitos com os quais você trabalha. O ClientVault já oferece:
