...
description: Perguntas frequentes sobre as configurações do ClientVault.
...
<AccordionGroup>
  ...
  <Accordion title="Posso alterar meu endereço de e-mail?">
    Para alterar seu endereço de e-mail, entre em contato pelo [contact@clientvault.com](mailto:contact@clientvault.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Posso personalizar o domínio do meu espaço de trabalho?">
    ...
    * **Subdomínio**: Use um subdomínio do ClientVault como `yourcompany.clientvault.com`
