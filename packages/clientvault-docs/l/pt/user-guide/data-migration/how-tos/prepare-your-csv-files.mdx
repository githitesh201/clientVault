...
description: Guia completo passo a passo para formatar seus dados para importação no ClientVault.
---
...
**Esta é a etapa mais importante.** O arquivo de exemplo mostra os nomes exatos das colunas e o formato que o ClientVault espera.
...
O ClientVault impõe unicidade em determinados campos. Duplicados causarão erros de importação.
...
3. Verifique se há duplicados que já existem no ClientVault
...
* Deve ser exclusivo (sem duplicados no arquivo ou no ClientVault)
...
* Deve ser exclusivo dentro do seu arquivo e no ClientVault
...
* **Links / Rótulo do Link**: `ClientVault`
* **Links / URL do Link**: `https://clientvault.com`
...
* **Opcional**: a ClientVault gera IDs automaticamente se não forem fornecidos
...
* O registro pai já deve existir na ClientVault
...
## Etapa 6: Garanta que os campos existam na ClientVault
