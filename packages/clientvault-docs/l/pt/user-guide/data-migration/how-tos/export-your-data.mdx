...
description: Guia completo passo a passo para exportar dados do ClientVault.
---
...
3. **Documente os mapeamentos de campos** — observe como os campos do ClientVault se mapeiam para o seu sistema de destino
