---
title: Painéis
description: Aprenda o básico sobre relatórios e painéis no ClientVault.
...
Os painéis no ClientVault oferecem uma forma visual de acompanhar suas principais métricas de desempenho e obter insights dos seus dados de CRM.
...
<Note>
  ...
  * A exportação de painéis e o compartilhamento com usuários externos (usuários não-ClientVault) não estão disponíveis no momento.
