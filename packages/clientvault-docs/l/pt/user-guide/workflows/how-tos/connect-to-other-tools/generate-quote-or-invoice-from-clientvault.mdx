---
title: Gerar um orçamento ou fatura no ClientVault
...
* [Gerar um PDF a partir do ClientVault](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — anexar PDFs gerados aos registros
