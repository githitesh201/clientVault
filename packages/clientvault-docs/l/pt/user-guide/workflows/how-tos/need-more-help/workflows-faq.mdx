...
description: Perguntas frequentes sobre fluxos de trabalho na ClientVault.
---
...
<AccordionGroup>
  ...
  <Accordion title="Quais são os limites de taxa dos fluxos de trabalho?">
    A ClientVault tem dois limites de taxa para garantir a estabilidade do sistema:
