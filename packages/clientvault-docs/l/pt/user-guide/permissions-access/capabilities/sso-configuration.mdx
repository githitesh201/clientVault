...
O Single Sign-On (SSO) permite que os membros da sua equipe façam login no ClientVault usando o provedor de identidade da sua organização. Isso oferece:
...
O ClientVault oferece suporte a SSO com:
...
* Acesso de administrador ao workspace do ClientVault

<Note>
  **Para usuários de auto-hospedagem que desejam configurar SSO**, entre em contato pelo contact@clientvault.com
</Note>
...
* **ID da Entidade**: Fornecido pelo ClientVault
* **URL ACS**: A URL de retorno para autenticação
* **Certificado**: Para comunicação segura

#### 4. Insira os detalhes do provedor no ClientVault
...
* Remova-os do workspace do ClientVault
...
* **Mapeamento de grupos**: Mapeie os grupos do IdP para as funções do ClientVault (se disponível)
* **Processo de desligamento**: Inclua o ClientVault no seu fluxo de trabalho de desprovisionamento
