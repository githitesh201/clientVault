...
description: Siga um guia passo a passo sobre como se registrar na ClientVault, escolher um plano de assinatura e configurar sua conta.
---
...
1. Navegue até [Cadastro ClientVault](https://app.clientvault.com).
...
Para dúvidas ou ajuda, conecte-se com a equipe de suporte dedicada em [contact@clientvault.com](mailto:contact@clientvault.com) ou envie uma mensagem no [Discord](https://discord.gg/cx5n4Jzs57).
