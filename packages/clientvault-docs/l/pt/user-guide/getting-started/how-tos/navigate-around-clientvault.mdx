---
title: Navegue pelo ClientVault
...
O menu de comandos oferece **acesso rápido a ações** no ClientVault. Você pode acessá-lo de duas maneiras:
...
* Acessar registros excluídos (ClientVault dá suporte a exclusões lógicas e permanentes)
