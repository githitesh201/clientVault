...
<Frame>
  <img src="/images/user-guide/what-is-clientvault/20.png" alt="Cabeçalho" />
</Frame>
      ...
      return (
        <RecoilRoot>
          <Select
            ...
            options={[
              { value: 'option1', label: 'Opção A', Icon: IconClientVaultStar },
              { value: 'option2', label: 'Opção B', Icon: IconClientVaultStar },
            ]}
            value="option1"
          />
        </RecoilRoot>
