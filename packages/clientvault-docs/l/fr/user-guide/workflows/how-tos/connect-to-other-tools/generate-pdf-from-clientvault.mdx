---
title: Générer un PDF depuis ClientVault
description: Créez un flux de travail pour générer et joindre un PDF (par exemple un devis) à un enregistrement.
---

Générez ou récupérez automatiquement un PDF et joignez-le à un enregistrement dans ClientVault. Cette fonctionnalité est couramment utilisée pour créer des devis, des factures ou des rapports liés aux Entreprises, aux Opportunités ou à d'autres objets.
...
2. Téléversement du fichier dans ClientVault
...
export const main = async (
  ...
  // Replace with your ClientVault GraphQL endpoint
  // Cloud: https://api.clientvault.com/graphql
  // Self-hosted: https://your-domain.com/graphql
  const graphqlEndpoint = 'https://api.clientvault.com/graphql';
...
* [Générer un devis ou une facture depuis ClientVault](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-clientvault)
