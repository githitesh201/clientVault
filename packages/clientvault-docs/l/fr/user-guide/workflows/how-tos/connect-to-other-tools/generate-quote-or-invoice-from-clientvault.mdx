---
title: Générer un devis ou une facture depuis ClientVault
...
* [Générer un PDF à partir de ClientVault](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — joindre les PDF générés aux enregistrements
