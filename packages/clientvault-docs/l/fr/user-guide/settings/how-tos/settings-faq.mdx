...
description: Foire aux questions sur les paramètres de ClientVault.
...
<AccordionGroup>
  ...
  <Accordion title="Puis-je changer mon adresse e-mail ?">
    Pour changer votre adresse e-mail, veuillez contacter [contact@clientvault.com](mailto:contact@clientvault.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Puis-je personnaliser le domaine de mon espace de travail ?">
    ...
    * **Sous-domaine** : Utilisez un sous-domaine ClientVault comme `yourcompany.clientvault.com`
