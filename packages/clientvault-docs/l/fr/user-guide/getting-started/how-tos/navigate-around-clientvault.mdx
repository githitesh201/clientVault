---
title: Naviguer dans ClientVault.
...
Le menu de commandes vous donne **un accès rapide aux actions** dans ClientVault. Vous pouvez y accéder de deux manières :
...
* Accéder aux enregistrements supprimés (ClientVault prend en charge les suppressions logiques et définitives)
