...
description: Formats de fichiers pris en charge pour l’importation de données dans ClientVault.
---

## Formats pris en charge

ClientVault prend en charge trois formats de fichiers pour l’importation :
