---
title: إنشاء عرض سعر أو فاتورة من ClientVault
...
* [Generate a PDF from ClientVault](/l/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — attach generated PDFs to records
