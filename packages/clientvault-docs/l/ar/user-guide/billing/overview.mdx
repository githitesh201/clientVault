---
title: الفوترة
description: تعرّف على تسعير ClientVault وأدِر اشتراكك.
...
تقدّم ClientVault خطط تسعير مرنة لتلبية احتياجات فريقك. أدِر اشتراكك، وتتبع أرصدة سير العمل، واطّلع على الفواتير — وكل ذلك من **Settings → Billing**.

## ما الذي يتضمنه هذا القسم

<CardGroup cols={٢}>
  <Card title="خطط التسعير" icon="tags" href="/l/ar/user-guide/billing/capabilities/pricing-plans">
    تعرّف على خطط تسعير ClientVault وما تتضمنه.
  </Card>
...
| **المؤسسة (مستضاف ذاتيًا)** | كل ما في Pro + ميزات Premium (SSO وأذونات على مستوى الصف)، دعم فريق ClientVault، ولا يُشترط نشر شيفرتك المخصصة كمصدر مفتوح قبل التوزيع |
...
**هل يمكنني استخدام ClientVault مجانًا؟**
نعم! استضف ClientVault ذاتيًا واحصل على جميع ميزات Pro دون تكلفة.
