...
<Frame>
  <img src="/images/user-guide/what-is-clientvault/20.png" alt="رأس الصفحة" />
</Frame>
      ...
      return (
        <RecoilRoot>
          <Select
            ...
            options={[
              { value: 'option1', label: 'Option A', Icon: IconClientVaultStar },
              { value: 'option2', label: 'Option B', Icon: IconClientVaultStar },
            ]}
            value="option1"
          />
        </RecoilRoot>
