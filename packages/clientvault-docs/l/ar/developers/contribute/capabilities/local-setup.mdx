...
description: الدليل للمساهمين (أو المطورين الفضوليين) الذين يرغبون في تشغيل ClientVault محلياً.
---
...
<Tabs>
  <Tab title="Linux و MacOS">
    قبل أن تتمكن من تثبيت واستخدام ClientVault، تأكد من تثبيت الأمور التالية على جهاز الكمبيوتر الخاص بك:
...
يتطلب ClientVault مخزن بيانات Redis لتقديم أفضل أداء
...
## الخطوة الثامنة: استخدم ClientVault

**الواجهة الأمامية**

ستكون واجهة ClientVault الأمامية تعمل على  [http://localhost:3001](http://localhost:3001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

* سيكون خادم ClientVault متصلاً ويعمل على [http://localhost:3000](http://localhost:3000)
