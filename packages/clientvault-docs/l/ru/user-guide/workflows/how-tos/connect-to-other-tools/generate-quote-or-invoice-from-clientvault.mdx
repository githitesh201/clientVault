---
title: Создайте коммерческое предложение или счёт из ClientVault
...
* [Сгенерировать PDF из ClientVault](/l/ru/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — прикрепляйте сгенерированные PDF-файлы к записям
