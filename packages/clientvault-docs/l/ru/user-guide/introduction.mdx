---
title: Откройте ClientVault
description: Добро пожаловать в Руководство пользователя ClientVault — ваш ресурс по расширенным настройкам и лучшим практикам.
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={3}>
  <Card href="/l/ru/user-guide/getting-started/capabilities/what-is-clientvault" img="/images/user-guide/api/api.png">
    <CardTitle>Откройте ClientVault</CardTitle>
    Узнайте, что такое ClientVault и как она может помочь вашему бизнесу.
  </Card>
