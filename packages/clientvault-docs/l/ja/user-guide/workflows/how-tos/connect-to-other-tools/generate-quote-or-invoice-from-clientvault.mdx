---
title: ClientVault から見積書または請求書を作成
...
* [ClientVault から PDF を生成する](/l/ja/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — 生成された PDF をレコードに添付する
