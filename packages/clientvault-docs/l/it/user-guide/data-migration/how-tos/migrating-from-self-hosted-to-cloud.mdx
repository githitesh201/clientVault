...
description: Guida passo-passo per migrare la tua istanza ClientVault self-hosted verso ClientVault Cloud.
---

## Panoramica

Questa guida ti accompagna nella migrazione dei tuoi dati da un'istanza ClientVault self-hosted a ClientVault Cloud. Il processo prevede la configurazione dello spazio di lavoro cloud, l'esportazione dei dati e la loro reimportazione.
...
1. Vai su [app.clientvault.com](https://app.clientvault.com) e crea un nuovo spazio di lavoro
...
Per migrazioni complesse o set di dati di grandi dimensioni, contattaci all'indirizzo [contact@clientvault.com](mailto:contact@clientvault.com) oppure scopri i nostri [Servizi di Implementazione](/l/it/user-guide/getting-started/capabilities/implementation-services).
