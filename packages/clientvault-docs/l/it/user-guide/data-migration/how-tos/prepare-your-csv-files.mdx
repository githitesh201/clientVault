...
description: Guida completa passo passo per formattare i tuoi dati per l'importazione in ClientVault.
---
...
**Questo è il passaggio più importante.** Il file di esempio ti mostra i nomi delle colonne e il formato esatti che ClientVault si aspetta.
...
ClientVault impone l'unicità su alcuni campi. I duplicati causeranno errori di importazione.
...
3. Verifica la presenza di duplicati già esistenti in ClientVault
...
* Deve essere univoco (nessun duplicato nel file o in ClientVault)
...
* Deve essere univoco all'interno del tuo file e in ClientVault
...
* **Link / Etichetta del link**: `ClientVault`
* **Link / URL del link**: `https://clientvault.com`
...
* **Opzionale**: ClientVault genera automaticamente gli ID se non forniti
...
* Il record padre deve già esistere in ClientVault
...
## Passaggio 6: Verifica che i campi esistano in ClientVault
