...
description: Quando e come usare le API di ClientVault per importazioni di dati su larga scala.
---

## Panoramica

ClientVault offre sia **GraphQL** che **API REST** per l'importazione programmatica dei dati. Usa l'API quando l'importazione CSV non è pratica per il tuo volume di dati o quando hai bisogno di importazioni automatizzate e ricorrenti.
...
ClientVault applica limiti di frequenza per garantire la stabilità del sistema:
...
ClientVault supporta due tipi di API:
...
* Verifica che i formati soddisfino i requisiti di ClientVault (vedi [Mappatura dei campi](/l/it/user-guide/data-migration/capabilities/field-mapping))
...
* Verifica che i dati compaiano correttamente in ClientVault
...
Contattaci a [contact@clientvault.com](mailto:contact@clientvault.com) oppure scopri i nostri [Servizi di implementazione](/l/it/user-guide/getting-started/capabilities/implementation-services).
