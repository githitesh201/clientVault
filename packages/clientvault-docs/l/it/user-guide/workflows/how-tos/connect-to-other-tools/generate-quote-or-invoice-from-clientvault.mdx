---
title: Genera un preventivo o una fattura da ClientVault
...
* [Generare un PDF da ClientVault](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — allegare i PDF generati ai record
