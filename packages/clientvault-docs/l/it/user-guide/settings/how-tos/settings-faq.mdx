...
description: Domande frequenti sulle impostazioni di ClientVault.
...
<AccordionGroup>
  ...
  <Accordion title="Posso cambiare il mio indirizzo email?">
    Per modificare il tuo indirizzo email, contatta [contact@clientvault.com](mailto:contact@clientvault.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Posso personalizzare il dominio del mio workspace?">
    ...
    * **Sottodominio**: usa un sottodominio di ClientVault come `yourcompany.clientvault.com`
