...
Il Single Sign-On (SSO) consente ai membri del tuo team di accedere a ClientVault utilizzando il provider di identità della tua organizzazione. Questo offre:
...
ClientVault supporta l'SSO con:
...
* Accesso amministratore allo spazio di lavoro ClientVault

<Note>
  **Per gli utenti self-hosting che desiderano configurare l'SSO**, contatta contact@clientvault.com
</Note>
...
* Rimuovili dallo spazio di lavoro ClientVault
...
* **Mappatura dei gruppi**: Mappa i gruppi IdP ai ruoli di ClientVault (se disponibile)
* **Processo di offboarding**: Includi ClientVault nel tuo flusso di lavoro di deprovisioning
