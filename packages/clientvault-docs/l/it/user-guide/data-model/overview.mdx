...
ClientVault include oggetti standard:
...
Ogni azienda lavora in modo diverso. Personalizzare il tuo modello di dati significa poter modellare ClientVault attorno ai **tuoi** processi invece di forzarli dentro un sistema rigido.

ClientVault offre massima flessibilità:
...
Identifica i concetti principali con cui lavori. ClientVault offre già:
