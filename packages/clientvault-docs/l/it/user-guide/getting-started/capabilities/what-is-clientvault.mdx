---
title: Che cos'è ClientVault
description: ClientVault è un CRM open source che ti fornisce i componenti di base per creare esattamente ciò di cui la tua azienda ha bisogno.
---
...
All'inizio, ClientVault appare come la maggior parte dei CRM che già conosci: puoi monitorare le trattative, organizzare i contatti, gestire compiti e note.
...
L'open-source è la base del nostro approccio, garantendo che ClientVault evolva con la sua comunità, per la sua comunità.
...
[Registrati qui](https://app.clientvault.com) o [diventa un collaboratore su GitHub](https://github.com/clientvaulthq/clientvault).
