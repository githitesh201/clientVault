---
title: Seleziona
image: /images/user-guide/what-is-clientvault/20.png
---

<Frame>
  <img src="/images/user-guide/what-is-clientvault/20.png" alt="Intestazione" />
</Frame>
...
<Tabs>
  <Tab title="Utilizzo">
    ...
    import { IconClientVaultStar } from 'clientvault-ui/display';
      ...
      return (
        <RecoilRoot>
          <Select
            ...
            options={[
              { value: 'option1', label: 'Opzione A', Icon: IconClientVaultStar },
              { value: 'option2', label: 'Opzione B', Icon: IconClientVaultStar },
            ]}
            value="option1"
          />
        </RecoilRoot>
