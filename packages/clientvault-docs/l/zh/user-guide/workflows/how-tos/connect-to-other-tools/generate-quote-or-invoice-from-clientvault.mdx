...
* [从 ClientVault 生成 PDF](/l/zh/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-clientvault) — 将生成的 PDF 附加到记录
