---
title: 从其他CRM迁移
description: 分步指南：将您的数据从任何客户关系管理系统迁移到 ClientVault。
---

## 概览

本指南将引导您将数据从任何客户关系管理系统迁移到 ClientVault。 该过程包括审核您的数据、准备您的 ClientVault 工作区、从当前系统导出，并导入到 ClientVault。
...
在您当前的客户关系管理系统与 ClientVault 之间创建一份映射文档：

| 您的客户关系管理系统    | ClientVault               |
| ------------- | -------------------- |
| 账户 / 组织       | **公司**               |
| 联系人 / 人员      | **人员**               |
| 交易 / 机会       | **Opportunity**      |
...
Contact [contact@clientvault.com](mailto:contact@clientvault.com) or explore our [Implementation Services](/l/zh/user-guide/getting-started/capabilities/implementation-services).
