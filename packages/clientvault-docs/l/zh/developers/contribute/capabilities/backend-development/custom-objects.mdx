...
对象是存储特定于组织的数据（记录、属性和值）的结构。 ClientVault 提供标准对象和自定义对象。

标准对象是为所有用户提供特定属性的内置对象。 ClientVault 的标准对象示例包括“公司”和“人员”。 标准对象具有对所有 ClientVault 用户可用的标准字段，如 Company.displayName。
