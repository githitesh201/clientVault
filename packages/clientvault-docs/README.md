# ClientVault Documentation

Official documentation for ClientVault CRM, powered by [Mintlify](https://mintlify.com).

## 🌐 Live Site

Visit the documentation at [docs.clientvault.com](https://docs.clientvault.com)

## 📚 Content

This repository contains:
- **User Guide** (46 pages) - Complete guide for ClientVault users
- **Developers** (24 pages) - Technical documentation for developers
- **ClientVault UI** (25 pages) - UI component library documentation
...
```bash
# From the clientvault monorepo root
npx nx run clientvault-docs:dev
```
...
1. Edit MDX files in the appropriate directory:
   ...
   - `clientvault-ui/` - Component documentation
...
4. For each translated locale pulled from Crowdin, ensure a `packages/clientvault-docs/l/<language>/navigation.json` file exists. These files contain **labels only**; page slugs always come from the base structure.
...
npx nx run clientvault-docs:build
```

## 🔗 Links

- [ClientVault Website](https://clientvault.com)
- [GitHub Repository](https://github.com/clientvaulthq/clientvault)
...
2. Make your changes in the `packages/clientvault-docs` directory
3. Test locally with `npx nx run clientvault-docs:dev`
4. Submit a pull request

## 📄 License

This documentation is part of the ClientVault project and is licensed under [AGPL-3.0](../../LICENSE).
