---
title: Self-Host
description: Deploy and manage ClientVault on your own infrastructure.
---
<Frame>
...
ClientVault can be self-hosted on your own infrastructure, giving you full control over your data and deployment.
