...
const createDefaultRoleConfig = async ({
  ...
  const content = `import { defineRole } from 'clientvault-sdk';
...
const createDefaultFrontComponent = async ({
  ...
  const content = `import { defineFrontComponent } from 'clientvault-sdk';
...
const createDefaultFunction = async ({
  ...
  const content = `import { defineLogicFunction } from 'clientvault-sdk';
...
const createExampleObject = async ({
  ...
  const content = `import { defineObject, FieldType } from 'clientvault-sdk';
...
const createExampleField = async ({
  ...
  const content = `import { defineField, FieldType } from 'clientvault-sdk';
...
const createExampleView = async ({
  ...
  const content = `import { defineView } from 'clientvault-sdk';
import { EXAMPLE_OBJECT_UNIVERSAL_IDENTIFIER } from 'src/objects/example-object';
...
const createExampleNavigationMenuItem = async ({
  ...
  const content = `import { defineNavigationMenuItem } from 'clientvault-sdk';
...
const createApplicationConfig = async ({
  ...
  const content = `import { defineApplication } from 'clientvault-sdk';
