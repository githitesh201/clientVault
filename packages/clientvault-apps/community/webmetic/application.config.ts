import { type ApplicationConfig } from 'clientvault-sdk/application';

const config: ApplicationConfig = {
  universalIdentifier: '8f3c5a1e-9b2d-4c7e-a5f3-1d8e9c2b4a6f',
  displayName: 'Webmetic Visitor Intelligence',
  description:
    'Automatically sync B2B website visitor data into ClientVault CRM. Identify companies visiting your website and track engagement without forms or manual entry.',
  applicationVariables: {
    CLIENTVAULT_API_KEY: {
      universalIdentifier: 'eb3866a1-36df-42f3-bcb8-351120b74096',
      description: 'ClientVault API key for authentication',
      isSecret: true,
    },
    CLIENTVAULT_API_URL: {
      universalIdentifier: '10dfe92a-b472-43e6-a33a-db89dcdd9bad',
      description: 'ClientVault API URL (base URL of your ClientVault instance)',
      isSecret: false,
      value: '',
    },
    WEBMETIC_API_KEY: {
