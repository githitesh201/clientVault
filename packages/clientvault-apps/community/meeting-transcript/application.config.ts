...
const config: ApplicationConfig = {
  ...
  applicationVariables: {
    CLIENTVAULT_API_KEY: {
      ...
      value: '',
      description:
        'API key for the ClientVault CRM instance (used for authentication).',
    },
    AI_PROVIDER_API_KEY: {
    ...
    CLIENTVAULT_API_URL: {
      ...
      isSecret: false,
      value: 'https://unpaid-interns.clientvault.com',
      description:
        'The base URL for the ClientVault CRM server (e.g., https://your-instance.clientvault.com).',
    },
