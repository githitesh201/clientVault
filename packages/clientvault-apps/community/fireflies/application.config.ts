import { type ApplicationConfig } from 'clientvault-sdk';

const config: ApplicationConfig = {
  universalIdentifier: 'a4df0c0f-c65e-44e5-8436-24814182d4ac',
  displayName: 'Fireflies',
  description: 'Sync Fireflies meeting summaries, sentiment, and action items into ClientVault.',
  icon: 'IconMicrophone',
  applicationVariables: {
    ...
    CLIENTVAULT_API_KEY: {
      ...
      description: 'ClientVault API key used when running scripts locally',
      //isSecret: true,
      value: '',
    },
    SERVER_URL: {
      universalIdentifier: '9b3a5e8e-5973-4e6b-a059-2966075652aa',
      description: 'Base URL for the ClientVault workspace (default: http://localhost:3000)',
