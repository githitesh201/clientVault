...
/**
 * Fetch historical Fireflies meetings and insert into ClientVault.
 *
 * Usage:
...
import { ClientVaultCrmService } from '../src/clientvault-crm-service';
import {
  getApiUrl,
  getFirefliesPlan,
...
const main = async (): Promise<void> => {
  ...
  if (!clientvaultApiKey) {
    console.error('❌ CLIENTVAULT_API_KEY is required');
    process.exit(1);
  }
