...
const config: ApplicationConfig = {
  ...
  applicationVariables: {
    CLIENTVAULT_API_KEY: {
      ...
      value: '',
      description:
        'Workspace API key used by the rollup engine to call the ClientVault REST API.',
    },
    CLIENTVAULT_API_BASE_URL: {
      universalIdentifier: '274c512c-a870-4651-9617-2638e0def14c',
      isSecret: false,
      value: '',
      description:
        'Optional override for the REST base URL (defaults to https://app.clientvault.com/rest).',
    },
