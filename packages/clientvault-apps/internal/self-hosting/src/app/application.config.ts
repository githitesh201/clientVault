import { defineApp } from 'clientvault-sdk';
...
export default defineApp({
  ...
  applicationVariables: {
    CLIENTVAULT_API_KEY: {
      ...
      description: 'ClientVault API key for creating selfHostingUser records',
      isSecret: true,
    },
    CLIENTVAULT_API_URL: {
      universalIdentifier: 'b2c3d4e5-f6a7-4b8c-9d0e-1f2a3b4c5d6e',
      description: 'ClientVault API URL (e.g., https://api.clientvault.com)',
      isSecret: false,
    },
  },
});
